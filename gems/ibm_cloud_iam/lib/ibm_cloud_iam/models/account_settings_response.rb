...
module IbmCloudIam
  class AccountSettingsResponse < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'restrict_user_list_visibility' => :'UserVisbilityRetrictActions',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::AccountSettingsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::AccountSettingsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_sessions_per_identity')
        ...
        self.max_sessions_per_identity = nil
      end
      ...
      if attributes.key?(:'restrict_user_list_visibility')
        ...
        self.restrict_user_list_visibility = 'NOT_RESTRICTED'
      end
      ...
      if attributes.key?(:'restrict_user_domains')
        if (value = attributes[:'restrict_user_domains']).is_a?(Array)
          self.restrict_user_domains = value
        end
      else
        self.restrict_user_domains = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @restrict_create_service_id.nil?
        invalid_properties.push('invalid value for "restrict_create_service_id", restrict_create_service_id cannot be nil.')
      end

      if @restrict_create_platform_apikey.nil?
        invalid_properties.push('invalid value for "restrict_create_platform_apikey", restrict_create_platform_apikey cannot be nil.')
      end

      if @allowed_ip_addresses.nil?
        invalid_properties.push('invalid value for "allowed_ip_addresses", allowed_ip_addresses cannot be nil.')
      end
      ...
      if @session_expiration_in_seconds.nil?
        invalid_properties.push('invalid value for "session_expiration_in_seconds", session_expiration_in_seconds cannot be nil.')
      end

      if @session_invalidation_in_seconds.nil?
        invalid_properties.push('invalid value for "session_invalidation_in_seconds", session_invalidation_in_seconds cannot be nil.')
      end

      if @max_sessions_per_identity.nil?
        invalid_properties.push('invalid value for "max_sessions_per_identity", max_sessions_per_identity cannot be nil.')
      end

      if @system_access_token_expiration_in_seconds.nil?
        invalid_properties.push('invalid value for "system_access_token_expiration_in_seconds", system_access_token_expiration_in_seconds cannot be nil.')
      end

      if @system_refresh_token_expiration_in_seconds.nil?
        invalid_properties.push('invalid value for "system_refresh_token_expiration_in_seconds", system_refresh_token_expiration_in_seconds cannot be nil.')
      end

      if @restrict_user_list_visibility.nil?
        invalid_properties.push('invalid value for "restrict_user_list_visibility", restrict_user_list_visibility cannot be nil.')
      end

      if @user_mfa.nil?
        invalid_properties.push('invalid value for "user_mfa", user_mfa cannot be nil.')
      end

      if @restrict_user_domains.nil?
        invalid_properties.push('invalid value for "restrict_user_domains", restrict_user_domains cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @restrict_create_service_id.nil?
      return false if @restrict_create_platform_apikey.nil?
      return false if @allowed_ip_addresses.nil?
      return false if @mfa.nil?
      return false if @session_expiration_in_seconds.nil?
      return false if @session_invalidation_in_seconds.nil?
      return false if @max_sessions_per_identity.nil?
      return false if @system_access_token_expiration_in_seconds.nil?
      return false if @system_refresh_token_expiration_in_seconds.nil?
      return false if @restrict_user_list_visibility.nil?
      return false if @user_mfa.nil?
      return false if @restrict_user_domains.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] restrict_create_service_id Value to be assigned
    def restrict_create_service_id=(restrict_create_service_id)
      if restrict_create_service_id.nil?
        fail ArgumentError, 'restrict_create_service_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] restrict_create_platform_apikey Value to be assigned
    def restrict_create_platform_apikey=(restrict_create_platform_apikey)
      if restrict_create_platform_apikey.nil?
        fail ArgumentError, 'restrict_create_platform_apikey cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] allowed_ip_addresses Value to be assigned
    def allowed_ip_addresses=(allowed_ip_addresses)
      if allowed_ip_addresses.nil?
        fail ArgumentError, 'allowed_ip_addresses cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] mfa Value to be assigned
    def mfa=(mfa)
      if mfa.nil?
        fail ArgumentError, 'mfa cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] session_expiration_in_seconds Value to be assigned
    def session_expiration_in_seconds=(session_expiration_in_seconds)
      if session_expiration_in_seconds.nil?
        fail ArgumentError, 'session_expiration_in_seconds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] session_invalidation_in_seconds Value to be assigned
    def session_invalidation_in_seconds=(session_invalidation_in_seconds)
      if session_invalidation_in_seconds.nil?
        fail ArgumentError, 'session_invalidation_in_seconds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] max_sessions_per_identity Value to be assigned
    def max_sessions_per_identity=(max_sessions_per_identity)
      if max_sessions_per_identity.nil?
        fail ArgumentError, 'max_sessions_per_identity cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] system_access_token_expiration_in_seconds Value to be assigned
    def system_access_token_expiration_in_seconds=(system_access_token_expiration_in_seconds)
      if system_access_token_expiration_in_seconds.nil?
        fail ArgumentError, 'system_access_token_expiration_in_seconds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] system_refresh_token_expiration_in_seconds Value to be assigned
    def system_refresh_token_expiration_in_seconds=(system_refresh_token_expiration_in_seconds)
      if system_refresh_token_expiration_in_seconds.nil?
        fail ArgumentError, 'system_refresh_token_expiration_in_seconds cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] restrict_user_list_visibility Value to be assigned
    def restrict_user_list_visibility=(restrict_user_list_visibility)
      if restrict_user_list_visibility.nil?
        fail ArgumentError, 'restrict_user_list_visibility cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] user_mfa Value to be assigned
    def user_mfa=(user_mfa)
      if user_mfa.nil?
        fail ArgumentError, 'user_mfa cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] restrict_user_domains Value to be assigned
    def restrict_user_domains=(restrict_user_domains)
      if restrict_user_domains.nil?
        fail ArgumentError, 'restrict_user_domains cannot be nil'
      end
