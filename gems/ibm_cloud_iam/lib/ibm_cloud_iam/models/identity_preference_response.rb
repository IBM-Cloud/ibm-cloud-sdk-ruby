...
module IbmCloudIam
  class IdentityPreferenceResponse < ApiModelBase
    ...
    attr_accessor :value_list_of_strings
    ...
    def self.openapi_types
      {
        ...
        :'scope' => :'String',
        :'value_string' => :'String',
        :'value_list_of_strings' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::IdentityPreferenceResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::IdentityPreferenceResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'value_list_of_strings')
        if (value = attributes[:'value_list_of_strings']).is_a?(Array)
          self.value_list_of_strings = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          value_list_of_strings == o.value_list_of_strings
    end
    ...
    def hash
      [service, id, account_id, scope, value_string, value_list_of_strings].hash
    end
