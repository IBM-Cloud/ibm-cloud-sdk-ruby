...
module IbmCloudIam
  class IdBasedMfaEnrollment < ApiModelBase
    attr_accessor :trait_account_default

    attr_accessor :trait_user_specific

    attr_accessor :trait_effective

    # The enrollment complies to the effective requirement.
    attr_accessor :complies
    ...
    def self.attribute_map
      {
        :'trait_account_default' => :'trait_account_default',
        :'trait_user_specific' => :'trait_user_specific',
        :'trait_effective' => :'trait_effective',
        :'complies' => :'complies',
        :'comply_state' => :'comply_state'
      }
    end
    ...
    def self.openapi_types
      {
        :'trait_account_default' => :'MfaOptions',
        :'trait_user_specific' => :'MfaOptions',
        :'trait_effective' => :'MfaOptions',
        :'complies' => :'Boolean',
        :'comply_state' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::IdBasedMfaEnrollment` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::IdBasedMfaEnrollment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'trait_account_default')
        self.trait_account_default = attributes[:'trait_account_default']
      else
        self.trait_account_default = nil
      end

      if attributes.key?(:'trait_user_specific')
        self.trait_user_specific = attributes[:'trait_user_specific']
      end

      if attributes.key?(:'trait_effective')
        self.trait_effective = attributes[:'trait_effective']
      else
        self.trait_effective = nil
      end

      if attributes.key?(:'complies')
        self.complies = attributes[:'complies']
      else
        self.complies = nil
      end

      if attributes.key?(:'comply_state')
        self.comply_state = attributes[:'comply_state']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @trait_account_default.nil?
        invalid_properties.push('invalid value for "trait_account_default", trait_account_default cannot be nil.')
      end

      if @trait_effective.nil?
        invalid_properties.push('invalid value for "trait_effective", trait_effective cannot be nil.')
      end

      if @complies.nil?
        invalid_properties.push('invalid value for "complies", complies cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @trait_account_default.nil?
      return false if @trait_effective.nil?
      return false if @complies.nil?
      comply_state_validator = EnumAttributeValidator.new('String', ["NO", "ACCOUNT", "CROSS_ACCOUNT"])
      return false unless comply_state_validator.valid?(@comply_state)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] trait_account_default Value to be assigned
    def trait_account_default=(trait_account_default)
      if trait_account_default.nil?
        fail ArgumentError, 'trait_account_default cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] trait_effective Value to be assigned
    def trait_effective=(trait_effective)
      if trait_effective.nil?
        fail ArgumentError, 'trait_effective cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] complies Value to be assigned
    def complies=(complies)
      if complies.nil?
        fail ArgumentError, 'complies cannot be nil'
      end
    ...
    # @param [Object] comply_state Object to be assigned
    def comply_state=(comply_state)
      validator = EnumAttributeValidator.new('String', ["NO", "ACCOUNT", "CROSS_ACCOUNT"])
      unless validator.valid?(comply_state)
        fail ArgumentError, "invalid value for \"comply_state\", must be one of #{validator.allowable_values}."
      end
      @comply_state = comply_state
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          trait_account_default == o.trait_account_default &&
          trait_user_specific == o.trait_user_specific &&
          trait_effective == o.trait_effective &&
          complies == o.complies &&
          comply_state == o.comply_state
    end
    ...
    def hash
      [trait_account_default, trait_user_specific, trait_effective, complies, comply_state].hash
    end
