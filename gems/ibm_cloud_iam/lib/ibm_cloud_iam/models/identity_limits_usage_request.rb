...
module IbmCloudIam
  # Request body format for identity limits usage query
  class IdentityLimitsUsageRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'serviceid_groups' => :'Boolean',
        :'serviceids_per_group' => :'Array<String>',
        :'profiles' => :'Boolean',
        :'apikeys_per_identity' => :'Array<String>',
        :'templates' => :'Boolean',
        :'template_versions_per_template' => :'Array<String>',
        :'idps' => :'Boolean',
        :'claim_rules_per_group' => :'Array<String>',
        :'claim_rules_per_profile' => :'Array<String>',
        :'cr_links' => :'Boolean',
        :'cr_links_per_profile' => :'Array<String>',
        :'cr_rules' => :'Boolean',
        :'cr_rules_per_profile' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::IdentityLimitsUsageRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::IdentityLimitsUsageRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'serviceids_per_group')
        if (value = attributes[:'serviceids_per_group']).is_a?(Array)
          self.serviceids_per_group = value
        end
      end
      ...
      if attributes.key?(:'apikeys_per_identity')
        if (value = attributes[:'apikeys_per_identity']).is_a?(Array)
          self.apikeys_per_identity = value
        end
      end
      ...
      if attributes.key?(:'template_versions_per_template')
        if (value = attributes[:'template_versions_per_template']).is_a?(Array)
          self.template_versions_per_template = value
        end
      end
      ...
      if attributes.key?(:'claim_rules_per_group')
        if (value = attributes[:'claim_rules_per_group']).is_a?(Array)
          self.claim_rules_per_group = value
        end
      end

      if attributes.key?(:'claim_rules_per_profile')
        if (value = attributes[:'claim_rules_per_profile']).is_a?(Array)
          self.claim_rules_per_profile = value
        end
      end
      ...
      if attributes.key?(:'cr_links_per_profile')
        if (value = attributes[:'cr_links_per_profile']).is_a?(Array)
          self.cr_links_per_profile = value
        end
      end
      ...
      if attributes.key?(:'cr_rules_per_profile')
        if (value = attributes[:'cr_rules_per_profile']).is_a?(Array)
          self.cr_rules_per_profile = value
        end
      end
    end
    ...
    def hash
      [serviceid_groups, serviceids_per_group, profiles, apikeys_per_identity, templates, template_versions_per_template, idps, claim_rules_per_group, claim_rules_per_profile, cr_links, cr_links_per_profile, cr_rules, cr_rules_per_profile].hash
    end
