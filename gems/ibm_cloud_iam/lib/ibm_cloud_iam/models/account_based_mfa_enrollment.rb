...
module IbmCloudIam
  class AccountBasedMfaEnrollment < ApiModelBase
    attr_accessor :security_questions

    attr_accessor :totp

    attr_accessor :verisign
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::AccountBasedMfaEnrollment` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::AccountBasedMfaEnrollment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'security_questions')
        self.security_questions = attributes[:'security_questions']
      else
      ...
      if attributes.key?(:'verisign')
        self.verisign = attributes[:'verisign']
      else
        self.verisign = nil
      end
    ...
    def list_invalid_properties
      ...
      if @security_questions.nil?
        invalid_properties.push('invalid value for "security_questions", security_questions cannot be nil.')
      end
      ...
      if @verisign.nil?
        invalid_properties.push('invalid value for "verisign", verisign cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @security_questions.nil?
      return false if @totp.nil?
      return false if @verisign.nil?
      return false if @complies.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] security_questions Value to be assigned
    def security_questions=(security_questions)
      if security_questions.nil?
        fail ArgumentError, 'security_questions cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] totp Value to be assigned
    def totp=(totp)
      if totp.nil?
        fail ArgumentError, 'totp cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] verisign Value to be assigned
    def verisign=(verisign)
      if verisign.nil?
        fail ArgumentError, 'verisign cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          security_questions == o.security_questions &&
          totp == o.totp &&
          verisign == o.verisign &&
          complies == o.complies
    end
    ...
    def hash
      [security_questions, totp, verisign, complies].hash
    end
