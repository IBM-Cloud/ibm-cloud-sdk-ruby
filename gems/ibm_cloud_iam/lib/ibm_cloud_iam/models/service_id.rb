...
module IbmCloudIam
  ...
  class ServiceId < ApiModelBase
    ...
    def hash
      [context, id, iam_id, entity_tag, crn, locked, created_at, modified_at, account_id, group_id, name, description, unique_instance_crns, history, apikey, activity].hash
    end
