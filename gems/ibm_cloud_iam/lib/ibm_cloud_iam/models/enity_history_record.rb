...
module IbmCloudIam
  ...
  class EnityHistoryRecord < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::EnityHistoryRecord` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::EnityHistoryRecord`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'iam_id_account')
        self.iam_id_account = attributes[:'iam_id_account']
      else
        self.iam_id_account = nil
      end
    ...
    def list_invalid_properties
      ...
      if @iam_id_account.nil?
        invalid_properties.push('invalid value for "iam_id_account", iam_id_account cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @iam_id_account.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] iam_id_account Value to be assigned
    def iam_id_account=(iam_id_account)
      if iam_id_account.nil?
        fail ArgumentError, 'iam_id_account cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          iam_id == o.iam_id &&
          iam_id_account == o.iam_id_account &&
          action == o.action &&
          params == o.params &&
          message == o.message
    end
    ...
    def hash
      [timestamp, iam_id, iam_id_account, action, params, message].hash
    end
