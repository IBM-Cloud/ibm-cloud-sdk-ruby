...
module IbmCloudIam
  ...
  class CreateIdpRequestPropertiesSp < ApiModelBase
    # Indicates if SP wants assertions to be signed
    attr_accessor :want_assertion_signed

    # Indicates if SP wants responses to be signed
    attr_accessor :want_response_signed

    # Indicates if responses should be encrypted
    attr_accessor :encrypt_response

    # Enables IDP-initiated login
    attr_accessor :idp_initiated_login_enabled

    # Enables logout URL when available
    attr_accessor :logout_url_enabled_when_available

    # URLs for IDP-initiated login (only when IdP initiated login is used)
    attr_accessor :idp_initiated_urls
    ...
    def self.attribute_map
      {
        ...
        :'logout_url_enabled_when_available' => :'logout_url_enabled_when_available',
        :'idp_initiated_urls' => :'idp_initiated_urls',
    ...
    def self.openapi_types
      {
        ...
        :'idp_initiated_urls' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::CreateIdpRequestPropertiesSp` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::CreateIdpRequestPropertiesSp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'want_assertion_signed')
        self.want_assertion_signed = attributes[:'want_assertion_signed']
      end

      if attributes.key?(:'want_response_signed')
        self.want_response_signed = attributes[:'want_response_signed']
      end

      if attributes.key?(:'encrypt_response')
        self.encrypt_response = attributes[:'encrypt_response']
      end

      if attributes.key?(:'idp_initiated_login_enabled')
        self.idp_initiated_login_enabled = attributes[:'idp_initiated_login_enabled']
      end

      if attributes.key?(:'logout_url_enabled_when_available')
        self.logout_url_enabled_when_available = attributes[:'logout_url_enabled_when_available']
      end

      if attributes.key?(:'idp_initiated_urls')
        if (value = attributes[:'idp_initiated_urls']).is_a?(Array)
          self.idp_initiated_urls = value
        end
      end

      if attributes.key?(:'authn_context')
        self.authn_context = attributes[:'authn_context']
      end

      if attributes.key?(:'claims')
        if (value = attributes[:'claims']).is_a?(Hash)
          self.claims = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          want_assertion_signed == o.want_assertion_signed &&
          want_response_signed == o.want_response_signed &&
          encrypt_response == o.encrypt_response &&
          idp_initiated_login_enabled == o.idp_initiated_login_enabled &&
          logout_url_enabled_when_available == o.logout_url_enabled_when_available &&
          idp_initiated_urls == o.idp_initiated_urls &&
          authn_context == o.authn_context &&
          claims == o.claims
    end
    ...
    def hash
      [want_assertion_signed, want_response_signed, encrypt_response, idp_initiated_login_enabled, logout_url_enabled_when_available, idp_initiated_urls, authn_context, claims].hash
    end
