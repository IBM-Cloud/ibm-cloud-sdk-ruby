...
module IbmCloudIam
  class UserReportMfaEnrollmentStatus < ApiModelBase
    # IAMid of the user
    ...
    attr_accessor :effective_mfa_type

    attr_accessor :id_based_mfa

    attr_accessor :account_based_mfa
    ...
    def self.attribute_map
      {
        ...
        :'username' => :'username',
        :'email' => :'email',
        :'effective_mfa_type' => :'effective_mfa_type',
        :'id_based_mfa' => :'id_based_mfa',
        :'account_based_mfa' => :'account_based_mfa'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::UserReportMfaEnrollmentStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::UserReportMfaEnrollmentStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'effective_mfa_type')
        self.effective_mfa_type = attributes[:'effective_mfa_type']
      else
        self.effective_mfa_type = nil
      end

      if attributes.key?(:'id_based_mfa')
        self.id_based_mfa = attributes[:'id_based_mfa']
      else
        self.id_based_mfa = nil
      end

      if attributes.key?(:'account_based_mfa')
        self.account_based_mfa = attributes[:'account_based_mfa']
      else
        self.account_based_mfa = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @effective_mfa_type.nil?
        invalid_properties.push('invalid value for "effective_mfa_type", effective_mfa_type cannot be nil.')
      end

      if @id_based_mfa.nil?
        invalid_properties.push('invalid value for "id_based_mfa", id_based_mfa cannot be nil.')
      end

      if @account_based_mfa.nil?
        invalid_properties.push('invalid value for "account_based_mfa", account_based_mfa cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @effective_mfa_type.nil?
      return false if @id_based_mfa.nil?
      return false if @account_based_mfa.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] effective_mfa_type Value to be assigned
    def effective_mfa_type=(effective_mfa_type)
      if effective_mfa_type.nil?
        fail ArgumentError, 'effective_mfa_type cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] id_based_mfa Value to be assigned
    def id_based_mfa=(id_based_mfa)
      if id_based_mfa.nil?
        fail ArgumentError, 'id_based_mfa cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] account_based_mfa Value to be assigned
    def account_based_mfa=(account_based_mfa)
      if account_based_mfa.nil?
        fail ArgumentError, 'account_based_mfa cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          username == o.username &&
          email == o.email &&
          effective_mfa_type == o.effective_mfa_type &&
          id_based_mfa == o.id_based_mfa &&
          account_based_mfa == o.account_based_mfa
    end
    ...
    def hash
      [iam_id, name, username, email, effective_mfa_type, id_based_mfa, account_based_mfa].hash
    end
