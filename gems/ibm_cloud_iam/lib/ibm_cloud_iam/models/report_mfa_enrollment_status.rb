...
module IbmCloudIam
  class ReportMfaEnrollmentStatus < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'users' => :'Array<UserReportMfaEnrollmentStatus>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::ReportMfaEnrollmentStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::ReportMfaEnrollmentStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'report_time')
        self.report_time = attributes[:'report_time']
      else
        self.report_time = nil
      end
      ...
      if attributes.key?(:'ims_account_id')
        self.ims_account_id = attributes[:'ims_account_id']
      end
    ...
    def list_invalid_properties
      ...
      if @report_time.nil?
        invalid_properties.push('invalid value for "report_time", report_time cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @report_time.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] report_time Value to be assigned
    def report_time=(report_time)
      if report_time.nil?
        fail ArgumentError, 'report_time cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          report_time == o.report_time &&
          account_id == o.account_id &&
          ims_account_id == o.ims_account_id &&
          users == o.users
    end
    ...
    def hash
      [created_by, reference, report_time, account_id, ims_account_id, users].hash
    end
