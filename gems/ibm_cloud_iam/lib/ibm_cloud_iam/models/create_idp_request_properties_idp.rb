...
module IbmCloudIam
  ...
  class CreateIdpRequestPropertiesIdp < ApiModelBase
    ...
    attr_accessor :redirect_binding_url

    # Indicates if IDP wants requests to be signed
    attr_accessor :want_request_signed
    ...
    def self.attribute_map
      {
        ...
        :'entity_id' => :'entity_id',
        :'redirect_binding_url' => :'redirect_binding_url',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::CreateIdpRequestPropertiesIdp` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::CreateIdpRequestPropertiesIdp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'xml_import')
        self.xml_import = attributes[:'xml_import']
      end
      ...
      if attributes.key?(:'redirect_binding_url')
        self.redirect_binding_url = attributes[:'redirect_binding_url']
      end

      if attributes.key?(:'want_request_signed')
        self.want_request_signed = attributes[:'want_request_signed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          xml_import == o.xml_import &&
          entity_id == o.entity_id &&
          redirect_binding_url == o.redirect_binding_url &&
          want_request_signed == o.want_request_signed &&
    ...
    def hash
      [xml_import, entity_id, redirect_binding_url, want_request_signed, logout_url].hash
    end
