...
module IbmCloudIam
  ...
  class IdentityLimitsUsageResponse < ApiModelBase
    attr_accessor :serviceid_groups

    attr_accessor :serviceids_per_group

    attr_accessor :profiles

    attr_accessor :apikeys_per_identity

    attr_accessor :profile_templates

    attr_accessor :account_settings_templates

    attr_accessor :template_versions_per_template

    attr_accessor :idps

    attr_accessor :claim_rules_per_group

    attr_accessor :claim_rules_per_profile

    attr_accessor :cr_links

    attr_accessor :cr_links_per_profile

    attr_accessor :cr_rules

    attr_accessor :cr_rules_per_profile
    ...
    def self.attribute_map
      {
        ...
        :'account_settings_templates' => :'account_settings_templates',
    ...
    def self.openapi_types
      {
        ...
        :'cr_links' => :'LimitCount',
        :'cr_links_per_profile' => :'IdentityLimitsUsageResponseClaimRulesPerProfile',
        :'cr_rules' => :'LimitCount',
        :'cr_rules_per_profile' => :'IdentityLimitsUsageResponseClaimRulesPerProfile'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudIam::IdentityLimitsUsageResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudIam::IdentityLimitsUsageResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'serviceid_groups')
        self.serviceid_groups = attributes[:'serviceid_groups']
      end

      if attributes.key?(:'serviceids_per_group')
        self.serviceids_per_group = attributes[:'serviceids_per_group']
      end
      ...
      if attributes.key?(:'apikeys_per_identity')
        self.apikeys_per_identity = attributes[:'apikeys_per_identity']
      end

      if attributes.key?(:'profile_templates')
        self.profile_templates = attributes[:'profile_templates']
      end

      if attributes.key?(:'account_settings_templates')
        self.account_settings_templates = attributes[:'account_settings_templates']
      end

      if attributes.key?(:'template_versions_per_template')
        self.template_versions_per_template = attributes[:'template_versions_per_template']
      end

      if attributes.key?(:'idps')
        self.idps = attributes[:'idps']
      end

      if attributes.key?(:'claim_rules_per_group')
        self.claim_rules_per_group = attributes[:'claim_rules_per_group']
      end

      if attributes.key?(:'claim_rules_per_profile')
        self.claim_rules_per_profile = attributes[:'claim_rules_per_profile']
      end

      if attributes.key?(:'cr_links')
        self.cr_links = attributes[:'cr_links']
      end

      if attributes.key?(:'cr_links_per_profile')
        self.cr_links_per_profile = attributes[:'cr_links_per_profile']
      end

      if attributes.key?(:'cr_rules')
        self.cr_rules = attributes[:'cr_rules']
      end

      if attributes.key?(:'cr_rules_per_profile')
        self.cr_rules_per_profile = attributes[:'cr_rules_per_profile']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          serviceid_groups == o.serviceid_groups &&
          serviceids_per_group == o.serviceids_per_group &&
          profiles == o.profiles &&
          apikeys_per_identity == o.apikeys_per_identity &&
          profile_templates == o.profile_templates &&
          account_settings_templates == o.account_settings_templates &&
          template_versions_per_template == o.template_versions_per_template &&
          idps == o.idps &&
          claim_rules_per_group == o.claim_rules_per_group &&
          claim_rules_per_profile == o.claim_rules_per_profile &&
          cr_links == o.cr_links &&
          cr_links_per_profile == o.cr_links_per_profile &&
          cr_rules == o.cr_rules &&
          cr_rules_per_profile == o.cr_rules_per_profile
    end
    ...
    def hash
      [serviceid_groups, serviceids_per_group, profiles, apikeys_per_identity, profile_templates, account_settings_templates, template_versions_per_template, idps, claim_rules_per_group, claim_rules_per_profile, cr_links, cr_links_per_profile, cr_rules, cr_rules_per_profile].hash
    end
