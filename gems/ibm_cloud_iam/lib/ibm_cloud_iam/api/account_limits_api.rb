...
module IbmCloudIam
  class AccountLimitsApi
    ...
    def bulk_list_account_entity_consumption(account_id, authorization, opts = {})
      data, _status_code, _headers = bulk_list_account_entity_consumption_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [IdentityLimitsUsageRequest] :identity_limits_usage_request 
    # @return [Array<(IdentityLimitsUsageResponse, Integer, Hash)>] IdentityLimitsUsageResponse data, response status code and response headers
    def bulk_list_account_entity_consumption_with_http_info(account_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountLimitsApi.bulk_list_account_entity_consumption ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountLimitsApi.bulk_list_account_entity_consumption"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountLimitsApi.bulk_list_account_entity_consumption"
      end
      # resource path
      local_var_path = '/v1/accounts/{account_id}/limits/identity'.sub('{account_id}', CGI.escape(account_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'identity_limits_usage_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'IdentityLimitsUsageResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountLimitsApi.bulk_list_account_entity_consumption",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountLimitsApi#bulk_list_account_entity_consumption\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [IdentityLimitsUsageResponse]
    def get_account_limits(account_id, authorization, opts = {})
      data, _status_code, _headers = get_account_limits_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    # @option opts [String] :cr_rules_per_profile Comma seperated list of profile IDs to include for cr rules consumption.
    # @return [Array<(IdentityLimitsUsageResponse, Integer, Hash)>] IdentityLimitsUsageResponse data, response status code and response headers
    def get_account_limits_with_http_info(account_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountLimitsApi.get_account_limits ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountLimitsApi.get_account_limits"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountLimitsApi.get_account_limits"
      end
      # resource path
      local_var_path = '/v1/accounts/{account_id}/limits/identity'.sub('{account_id}', CGI.escape(account_id.to_s))
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'serviceid_groups'] = opts[:'serviceid_groups'] if !opts[:'serviceid_groups'].nil?
      query_params[:'serviceids_per_group'] = opts[:'serviceids_per_group'] if !opts[:'serviceids_per_group'].nil?
      query_params[:'profiles'] = opts[:'profiles'] if !opts[:'profiles'].nil?
      query_params[:'apikeys_per_identity'] = opts[:'apikeys_per_identity'] if !opts[:'apikeys_per_identity'].nil?
      query_params[:'templates'] = opts[:'templates'] if !opts[:'templates'].nil?
      query_params[:'template_versions_per_template'] = opts[:'template_versions_per_template'] if !opts[:'template_versions_per_template'].nil?
      query_params[:'idps'] = opts[:'idps'] if !opts[:'idps'].nil?
      query_params[:'claim_rules_per_group'] = opts[:'claim_rules_per_group'] if !opts[:'claim_rules_per_group'].nil?
      query_params[:'claim_rules_per_profile'] = opts[:'claim_rules_per_profile'] if !opts[:'claim_rules_per_profile'].nil?
      query_params[:'cr_links'] = opts[:'cr_links'] if !opts[:'cr_links'].nil?
      query_params[:'cr_links_per_profile'] = opts[:'cr_links_per_profile'] if !opts[:'cr_links_per_profile'].nil?
      query_params[:'cr_rules'] = opts[:'cr_rules'] if !opts[:'cr_rules'].nil?
      query_params[:'cr_rules_per_profile'] = opts[:'cr_rules_per_profile'] if !opts[:'cr_rules_per_profile'].nil?
      ...
      new_options = opts.merge(
        :operation => :"AccountLimitsApi.get_account_limits",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountLimitsApi#get_account_limits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
