...
module IbmCloudIam
  class AccountSettingsForIdPApi
    ...
    # Add IdP Setting
    # 
    # @param account_id [String] Account which is bound to the IDP
    # @param idp_id [String] Identity provider ID
    ...
    # @param add_account_idp_setting_request [AddAccountIdpSettingRequest] Request to add idp
    # @param [Hash] opts the optional parameters
    # @return [AccountIdpSettings]
    def add_id_p_setting(account_id, idp_id, authorization, add_account_idp_setting_request, opts = {})
      data, _status_code, _headers = add_id_p_setting_with_http_info(account_id, idp_id, authorization, add_account_idp_setting_request, opts)
      data
    end
    ...
    # @param add_account_idp_setting_request [AddAccountIdpSettingRequest] Request to add idp
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountIdpSettings, Integer, Hash)>] AccountIdpSettings data, response status code and response headers
    def add_id_p_setting_with_http_info(account_id, idp_id, authorization, add_account_idp_setting_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.add_id_p_setting ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.add_id_p_setting"
      end
      # verify the required parameter 'idp_id' is set
      if @api_client.config.client_side_validation && idp_id.nil?
        fail ArgumentError, "Missing the required parameter 'idp_id' when calling AccountSettingsForIdPApi.add_id_p_setting"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.add_id_p_setting"
      end
      # verify the required parameter 'add_account_idp_setting_request' is set
      if @api_client.config.client_side_validation && add_account_idp_setting_request.nil?
        fail ArgumentError, "Missing the required parameter 'add_account_idp_setting_request' when calling AccountSettingsForIdPApi.add_id_p_setting"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}/idps/{idp_id}'.sub('{account_id}', CGI.escape(account_id.to_s)).sub('{idp_id}', CGI.escape(idp_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(add_account_idp_setting_request)

      # return_type
      return_type = opts[:debug_return_type] || 'AccountIdpSettings'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.add_id_p_setting",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#add_id_p_setting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [AccountIdpSettings]
    def get_id_p_setting(account_id, idp_id, authorization, opts = {})
      data, _status_code, _headers = get_id_p_setting_with_http_info(account_id, idp_id, authorization, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountIdpSettings, Integer, Hash)>] AccountIdpSettings data, response status code and response headers
    def get_id_p_setting_with_http_info(account_id, idp_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.get_id_p_setting ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.get_id_p_setting"
      end
      # verify the required parameter 'idp_id' is set
      if @api_client.config.client_side_validation && idp_id.nil?
        fail ArgumentError, "Missing the required parameter 'idp_id' when calling AccountSettingsForIdPApi.get_id_p_setting"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.get_id_p_setting"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}/idps/{idp_id}'.sub('{account_id}', CGI.escape(account_id.to_s)).sub('{idp_id}', CGI.escape(idp_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.get_id_p_setting",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#get_id_p_setting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param account_id [String] Account which is bound to the alias
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Please make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [AccountLoginSettings]
    def get_login_settings(account_id, authorization, opts = {})
      data, _status_code, _headers = get_login_settings_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Please make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountLoginSettings, Integer, Hash)>] AccountLoginSettings data, response status code and response headers
    def get_login_settings_with_http_info(account_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.get_login_settings ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.get_login_settings"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.get_login_settings"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}'.sub('{account_id}', CGI.escape(account_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AccountLoginSettings'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.get_login_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#get_login_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_id_p_settings(authorization, account_id, opts = {})
      data, _status_code, _headers = list_id_p_settings_with_http_info(authorization, account_id, opts)
      data
    end
    ...
    # @option opts [String] :type Type of IDP
    # @option opts [String] :include_idp_metadata Flag if meta-information about account and idp should be included
    # @return [Array<(ListIdPSettings200Response, Integer, Hash)>] ListIdPSettings200Response data, response status code and response headers
    def list_id_p_settings_with_http_info(authorization, account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.list_id_p_settings ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.list_id_p_settings"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.list_id_p_settings"
      end
      allowable_values = ["consumeable", "consumed"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}/idps'.sub('{account_id}', CGI.escape(account_id.to_s))

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'type'] = opts[:'type'] if !opts[:'type'].nil?
      query_params[:'include_idp_metadata'] = opts[:'include_idp_metadata'] if !opts[:'include_idp_metadata'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListIdPSettings200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.list_id_p_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#list_id_p_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def remove_id_p_setting(account_id, idp_id, authorization, opts = {})
      remove_id_p_setting_with_http_info(account_id, idp_id, authorization, opts)
      nil
    end
    ...
    def remove_id_p_setting_with_http_info(account_id, idp_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.remove_id_p_setting ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.remove_id_p_setting"
      end
      # verify the required parameter 'idp_id' is set
      if @api_client.config.client_side_validation && idp_id.nil?
        fail ArgumentError, "Missing the required parameter 'idp_id' when calling AccountSettingsForIdPApi.remove_id_p_setting"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.remove_id_p_setting"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}/idps/{idp_id}'.sub('{account_id}', CGI.escape(account_id.to_s)).sub('{idp_id}', CGI.escape(idp_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.remove_id_p_setting",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#remove_id_p_setting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param idp_id [String] Identity provider ID
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Please make sure that the provided token has the required authority for the request.
    # @param update_account_idp_setting_request [UpdateAccountIdpSettingRequest] Request to update idp
    # @param [Hash] opts the optional parameters
    # @return [AccountIdpSettings]
    def update_id_p_setting(account_id, idp_id, authorization, update_account_idp_setting_request, opts = {})
      data, _status_code, _headers = update_id_p_setting_with_http_info(account_id, idp_id, authorization, update_account_idp_setting_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountIdpSettings, Integer, Hash)>] AccountIdpSettings data, response status code and response headers
    def update_id_p_setting_with_http_info(account_id, idp_id, authorization, update_account_idp_setting_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.update_id_p_setting ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.update_id_p_setting"
      end
      # verify the required parameter 'idp_id' is set
      if @api_client.config.client_side_validation && idp_id.nil?
        fail ArgumentError, "Missing the required parameter 'idp_id' when calling AccountSettingsForIdPApi.update_id_p_setting"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.update_id_p_setting"
      end
      # verify the required parameter 'update_account_idp_setting_request' is set
      if @api_client.config.client_side_validation && update_account_idp_setting_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_account_idp_setting_request' when calling AccountSettingsForIdPApi.update_id_p_setting"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}/idps/{idp_id}'.sub('{account_id}', CGI.escape(account_id.to_s)).sub('{idp_id}', CGI.escape(idp_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_account_idp_setting_request)
      ...
      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.update_id_p_setting",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#update_id_p_setting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param account_id [String] Account which is bound to the alias
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Please make sure that the provided token has the required authority for the request.
    # @param update_account_login_settings [UpdateAccountLoginSettings] Request to update
    # @param [Hash] opts the optional parameters
    # @return [AccountLoginSettings]
    def update_login_settings(account_id, authorization, update_account_login_settings, opts = {})
      data, _status_code, _headers = update_login_settings_with_http_info(account_id, authorization, update_account_login_settings, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountLoginSettings, Integer, Hash)>] AccountLoginSettings data, response status code and response headers
    def update_login_settings_with_http_info(account_id, authorization, update_account_login_settings, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountSettingsForIdPApi.update_login_settings ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountSettingsForIdPApi.update_login_settings"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AccountSettingsForIdPApi.update_login_settings"
      end
      # verify the required parameter 'update_account_login_settings' is set
      if @api_client.config.client_side_validation && update_account_login_settings.nil?
        fail ArgumentError, "Missing the required parameter 'update_account_login_settings' when calling AccountSettingsForIdPApi.update_login_settings"
      end
      # resource path
      local_var_path = '/v2/loginsettings/{account_id}'.sub('{account_id}', CGI.escape(account_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_account_login_settings)
      ...
      new_options = opts.merge(
        :operation => :"AccountSettingsForIdPApi.update_login_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountSettingsForIdPApi#update_login_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
