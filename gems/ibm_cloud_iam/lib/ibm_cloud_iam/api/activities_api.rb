...
module IbmCloudIam
  class ActivitiesApi
    ...
    # @option opts [String] :type Optional report type. The supported value is &#39;inactive&#39;. List all identities that have not authenticated within the time indicated by duration. (default to 'inactive')
    # @option opts [String] :duration Optional duration of the report. The supported unit of duration is hours. (default to '720')
    # @return [ReportReference]
    def create_report(account_id, authorization, opts = {})
      data, _status_code, _headers = create_report_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    def create_report_with_http_info(account_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActivitiesApi.create_report ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling ActivitiesApi.create_report"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ActivitiesApi.create_report"
      end
      # resource path
      local_var_path = '/v1/activity/accounts/{account_id}/report'.sub('{account_id}', CGI.escape(account_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ActivitiesApi.create_report",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActivitiesApi#create_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Report]
    def get_report(account_id, reference, authorization, opts = {})
      data, _status_code, _headers = get_report_with_http_info(account_id, reference, authorization, opts)
      data
    end
    ...
    def get_report_with_http_info(account_id, reference, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActivitiesApi.get_report ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling ActivitiesApi.get_report"
      end
      # verify the required parameter 'reference' is set
      if @api_client.config.client_side_validation && reference.nil?
        fail ArgumentError, "Missing the required parameter 'reference' when calling ActivitiesApi.get_report"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ActivitiesApi.get_report"
      end
      # resource path
      local_var_path = '/v1/activity/accounts/{account_id}/report/{reference}'.sub('{account_id}', CGI.escape(account_id.to_s)).sub('{reference}', CGI.escape(reference.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ActivitiesApi.get_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActivitiesApi#get_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
