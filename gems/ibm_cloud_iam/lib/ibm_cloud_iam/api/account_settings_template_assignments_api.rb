...
module IbmCloudIam
  class AccountSettingsTemplateAssignmentsApi
    ...
    def create_account_settings_assignment(create_template_assignment_request, opts = {})
      data, _status_code, _headers = create_account_settings_assignment_with_http_info(create_template_assignment_request, opts)
      data
    end
    ...
    def create_account_settings_assignment_with_http_info(create_template_assignment_request, opts = {})
    ...
    def delete_account_settings_assignment(assignment_id, opts = {})
      data, _status_code, _headers = delete_account_settings_assignment_with_http_info(assignment_id, opts)
      data
    end
    ...
    def delete_account_settings_assignment_with_http_info(assignment_id, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @return [TemplateAssignmentResponse]
    def get_account_settings_assignment(assignment_id, opts = {})
      data, _status_code, _headers = get_account_settings_assignment_with_http_info(assignment_id, opts)
      data
    end
    ...
    # @option opts [String] :authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @return [Array<(TemplateAssignmentResponse, Integer, Hash)>] TemplateAssignmentResponse data, response status code and response headers
    def get_account_settings_assignment_with_http_info(assignment_id, opts = {})
      if @api_client.config.debugging
    ...
    def list_account_settings_assignments(opts = {})
      data, _status_code, _headers = list_account_settings_assignments_with_http_info(opts)
      data
    end
    ...
    def list_account_settings_assignments_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @return [TemplateAssignmentResponse]
    def update_account_settings_assignment(assignment_id, if_match, update_template_assignment_request, opts = {})
      data, _status_code, _headers = update_account_settings_assignment_with_http_info(assignment_id, if_match, update_template_assignment_request, opts)
      data
    end
    ...
    # @option opts [String] :authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @return [Array<(TemplateAssignmentResponse, Integer, Hash)>] TemplateAssignmentResponse data, response status code and response headers
    def update_account_settings_assignment_with_http_info(assignment_id, if_match, update_template_assignment_request, opts = {})
      if @api_client.config.debugging
