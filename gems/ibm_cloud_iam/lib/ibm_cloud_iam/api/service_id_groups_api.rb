...
module IbmCloudIam
  class ServiceIDGroupsApi
    ...
    # @param create_service_id_group_request [CreateServiceIdGroupRequest] Request to create a service ID Group.
    # @param [Hash] opts the optional parameters
    # @return [ServiceIdGroup]
    ...
    # @param create_service_id_group_request [CreateServiceIdGroupRequest] Request to create a service ID Group.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ServiceIdGroup, Integer, Hash)>] ServiceIdGroup data, response status code and response headers
    ...
    # Delete a service ID group.
    # @param id [String] Unique ID of the service ID group.
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :account_id Account ID of the service ID groups to query
    # @return [ServiceIdGroupList]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :account_id Account ID of the service ID groups to query
    # @return [Array<(ServiceIdGroupList, Integer, Hash)>] ServiceIdGroupList data, response status code and response headers
    ...
    # Update a service ID group
    # @param id [String] Unique ID of the service ID group to be updated.
    # @param if_match [String] Version of the service ID gorup to be updated. Specify the version that you retrieved when reading service ID group. This value helps identifying parallel usage of this API. Pass * to indicate to update any version available. This might result in stale updates.
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param update_service_id_group_request [UpdateServiceIdGroupRequest] Request to update service ID group.
    # @param [Hash] opts the optional parameters
    # @return [ServiceIdGroup]
