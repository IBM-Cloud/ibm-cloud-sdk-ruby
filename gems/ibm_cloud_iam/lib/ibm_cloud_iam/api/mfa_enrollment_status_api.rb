...
module IbmCloudIam
  class MFAEnrollmentStatusApi
    ...
    # @option opts [String] :type Optional report type. The supported value is &#39;mfa_status&#39;. List MFA enrollment status for all the identities.
    # @return [ReportReference]
    def create_mfa_report(account_id, authorization, opts = {})
      data, _status_code, _headers = create_mfa_report_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :type Optional report type. The supported value is &#39;mfa_status&#39;. List MFA enrollment status for all the identities.
    # @return [Array<(ReportReference, Integer, Hash)>] ReportReference data, response status code and response headers
    def create_mfa_report_with_http_info(account_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MFAEnrollmentStatusApi.create_mfa_report ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling MFAEnrollmentStatusApi.create_mfa_report"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling MFAEnrollmentStatusApi.create_mfa_report"
      end
      # resource path
      local_var_path = '/v1/mfa/accounts/{account_id}/report'.sub('{account_id}', CGI.escape(account_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ReportReference'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"MFAEnrollmentStatusApi.create_mfa_report",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MFAEnrollmentStatusApi#create_mfa_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param account_id [String] ID of the account
    # @param reference [String] Reference for the report to be generated, You can use &#39;latest&#39; to get the latest report for the given account.
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [ReportMfaEnrollmentStatus]
    def get_mfa_report(account_id, reference, authorization, opts = {})
      data, _status_code, _headers = get_mfa_report_with_http_info(account_id, reference, authorization, opts)
      data
    end
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReportMfaEnrollmentStatus, Integer, Hash)>] ReportMfaEnrollmentStatus data, response status code and response headers
    def get_mfa_report_with_http_info(account_id, reference, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MFAEnrollmentStatusApi.get_mfa_report ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling MFAEnrollmentStatusApi.get_mfa_report"
      end
      # verify the required parameter 'reference' is set
      if @api_client.config.client_side_validation && reference.nil?
        fail ArgumentError, "Missing the required parameter 'reference' when calling MFAEnrollmentStatusApi.get_mfa_report"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling MFAEnrollmentStatusApi.get_mfa_report"
      end
      # resource path
      local_var_path = '/v1/mfa/accounts/{account_id}/report/{reference}'.sub('{account_id}', CGI.escape(account_id.to_s)).sub('{reference}', CGI.escape(reference.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ReportMfaEnrollmentStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"MFAEnrollmentStatusApi.get_mfa_report",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MFAEnrollmentStatusApi#get_mfa_report\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # Get MFA enrollment status for a single user in the account.
    # @param account_id [String] ID of the account
    # @param iam_id [String] iam_id of the user. This user must be the member of the account.
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [UserMfaEnrollments]
    def get_mfa_status(account_id, iam_id, authorization, opts = {})
      data, _status_code, _headers = get_mfa_status_with_http_info(account_id, iam_id, authorization, opts)
      data
    end
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserMfaEnrollments, Integer, Hash)>] UserMfaEnrollments data, response status code and response headers
    def get_mfa_status_with_http_info(account_id, iam_id, authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MFAEnrollmentStatusApi.get_mfa_status ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling MFAEnrollmentStatusApi.get_mfa_status"
      end
      # verify the required parameter 'iam_id' is set
      if @api_client.config.client_side_validation && iam_id.nil?
        fail ArgumentError, "Missing the required parameter 'iam_id' when calling MFAEnrollmentStatusApi.get_mfa_status"
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling MFAEnrollmentStatusApi.get_mfa_status"
      end
      # resource path
      local_var_path = '/v1/mfa/accounts/{account_id}/status'.sub('{account_id}', CGI.escape(account_id.to_s))

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'iam_id'] = iam_id
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserMfaEnrollments'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"MFAEnrollmentStatusApi.get_mfa_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MFAEnrollmentStatusApi#get_mfa_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
