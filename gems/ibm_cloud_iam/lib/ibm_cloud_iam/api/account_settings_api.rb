...
module IbmCloudIam
  class AccountSettingsApi
    ...
    # @option opts [Boolean] :resolve_user_mfa Enrich MFA exemptions with user PI. (default to false)
    # @return [AccountSettingsResponse]
    def get_account_settings(account_id, authorization, opts = {})
      data, _status_code, _headers = get_account_settings_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    def get_account_settings_with_http_info(account_id, authorization, opts = {})
      ...
      # resource path
      local_var_path = '/v1/accounts/{account_id}/settings/identity'.sub('{account_id}', CGI.escape(account_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :include_history Defines if the entity history is included in the response. (default to false)
    # @option opts [Boolean] :resolve_user_mfa Enrich MFA exemptions with user information. (default to false)
    # @return [EffectiveAccountSettingsResponse]
    def get_effective_account_settings(account_id, authorization, opts = {})
      data, _status_code, _headers = get_effective_account_settings_with_http_info(account_id, authorization, opts)
      data
    end
    ...
    # @option opts [Boolean] :include_history Defines if the entity history is included in the response. (default to false)
    # @option opts [Boolean] :resolve_user_mfa Enrich MFA exemptions with user information. (default to false)
    # @return [Array<(EffectiveAccountSettingsResponse, Integer, Hash)>] EffectiveAccountSettingsResponse data, response status code and response headers
    def get_effective_account_settings_with_http_info(account_id, authorization, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/v1/accounts/{account_id}/effective_settings/identity'.sub('{account_id}', CGI.escape(account_id.to_s))
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param if_match [String] Version of the account settings to be updated. Specify the version that you retrieved as entity_tag (ETag header) when reading the account. This value helps identifying parallel usage of this API. Pass * to indicate to update any version available. This might result in stale updates.
    # @param account_id [String] The id of the account to update the settings for.
    # @param account_settings_request [AccountSettingsRequest] Request to update an account&#39;s settings.
    # @param [Hash] opts the optional parameters
    # @return [AccountSettingsResponse]
    def update_account_settings(authorization, if_match, account_id, account_settings_request, opts = {})
      data, _status_code, _headers = update_account_settings_with_http_info(authorization, if_match, account_id, account_settings_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountSettingsResponse, Integer, Hash)>] AccountSettingsResponse data, response status code and response headers
    def update_account_settings_with_http_info(authorization, if_match, account_id, account_settings_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && account_settings_request.nil?
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(account_settings_request)
