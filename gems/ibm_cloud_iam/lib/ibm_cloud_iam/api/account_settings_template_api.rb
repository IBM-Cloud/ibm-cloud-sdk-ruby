...
module IbmCloudIam
  class AccountSettingsTemplateApi
    ...
    # @param template_id [String] ID of the account settings template
    # @param version [String] Version of the account settings template
    ...
    # @return [nil]
    def commit_account_settings_template(template_id, version, authorization, opts = {})
      commit_account_settings_template_with_http_info(template_id, version, authorization, opts)
      nil
    end
    ...
    def commit_account_settings_template_with_http_info(template_id, version, authorization, opts = {})
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param account_settings_template_request [AccountSettingsTemplateRequest] Request to create an account settings template.
    # @param [Hash] opts the optional parameters
    # @return [AccountSettingsTemplateResponse]
    def create_account_settings_template(authorization, account_settings_template_request, opts = {})
      data, _status_code, _headers = create_account_settings_template_with_http_info(authorization, account_settings_template_request, opts)
      data
    end
    ...
    # @param account_settings_template_request [AccountSettingsTemplateRequest] Request to create an account settings template.
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountSettingsTemplateResponse, Integer, Hash)>] AccountSettingsTemplateResponse data, response status code and response headers
    def create_account_settings_template_with_http_info(authorization, account_settings_template_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && account_settings_template_request.nil?
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(account_settings_template_request)
    ...
    # @param template_id [String] ID of the account settings template
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param account_settings_template_request [AccountSettingsTemplateRequest] Request to create new version of an account settings template
    # @param [Hash] opts the optional parameters
    # @return [AccountSettingsTemplateResponse]
    def create_account_settings_template_version(template_id, authorization, account_settings_template_request, opts = {})
      data, _status_code, _headers = create_account_settings_template_version_with_http_info(template_id, authorization, account_settings_template_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountSettingsTemplateResponse, Integer, Hash)>] AccountSettingsTemplateResponse data, response status code and response headers
    def create_account_settings_template_version_with_http_info(template_id, authorization, account_settings_template_request, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_account_settings_template_version(template_id, version, authorization, opts = {})
      delete_account_settings_template_version_with_http_info(template_id, version, authorization, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_account_settings_template_version_with_http_info(template_id, version, authorization, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_all_versions_of_account_settings_template(template_id, authorization, opts = {})
      delete_all_versions_of_account_settings_template_with_http_info(template_id, authorization, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_all_versions_of_account_settings_template_with_http_info(template_id, authorization, opts = {})
      if @api_client.config.debugging
    ...
    # @return [AccountSettingsTemplateResponse]
    def get_account_settings_template_version(template_id, version, authorization, opts = {})
      data, _status_code, _headers = get_account_settings_template_version_with_http_info(template_id, version, authorization, opts)
      data
    end
    ...
    # @option opts [Boolean] :include_history Defines if the entity history is included in the response (default to false)
    # @return [Array<(AccountSettingsTemplateResponse, Integer, Hash)>] AccountSettingsTemplateResponse data, response status code and response headers
    def get_account_settings_template_version_with_http_info(template_id, version, authorization, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [Boolean] :include_history Defines if the entity history is included in the response (default to false)
    # @return [AccountSettingsTemplateResponse]
    def get_latest_account_settings_template_version(template_id, authorization, opts = {})
      data, _status_code, _headers = get_latest_account_settings_template_version_with_http_info(template_id, authorization, opts)
      data
    end
    ...
    # @option opts [Boolean] :include_history Defines if the entity history is included in the response (default to false)
    # @return [Array<(AccountSettingsTemplateResponse, Integer, Hash)>] AccountSettingsTemplateResponse data, response status code and response headers
    def get_latest_account_settings_template_version_with_http_info(template_id, authorization, opts = {})
      if @api_client.config.debugging
    ...
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :account_id Account ID of the account settings templates to query. This parameter is required unless using a pagetoken.
    ...
    # @return [AccountSettingsTemplateList]
    def list_account_settings_templates(authorization, opts = {})
      data, _status_code, _headers = list_account_settings_templates_with_http_info(authorization, opts)
      data
    end
    ...
    # @option opts [String] :order Optional sort order. (default to 'asc')
    # @option opts [String] :include_history Defines if the entity history is included in the response (default to 'false')
    # @return [Array<(AccountSettingsTemplateList, Integer, Hash)>] AccountSettingsTemplateList data, response status code and response headers
    def list_account_settings_templates_with_http_info(authorization, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :include_history Defines if the entity history is included in the response (default to 'false')
    # @return [AccountSettingsTemplateList]
    def list_versions_of_account_settings_template(template_id, authorization, opts = {})
      data, _status_code, _headers = list_versions_of_account_settings_template_with_http_info(template_id, authorization, opts)
      data
    end
    ...
    # @option opts [String] :include_history Defines if the entity history is included in the response (default to 'false')
    # @return [Array<(AccountSettingsTemplateList, Integer, Hash)>] AccountSettingsTemplateList data, response status code and response headers
    def list_versions_of_account_settings_template_with_http_info(template_id, authorization, opts = {})
      if @api_client.config.debugging
    ...
    # @param if_match [String] Entity tag of the Template to be updated. Specify the tag that you retrieved when reading the account settings template. This value helps identifying parallel usage of this API. Pass * to indicate to update any version available. This might result in stale updates. 
    # @param template_id [String] ID of the account settings template
    # @param version [String] Version of the account settings template
    # @param authorization [String] Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
    # @param account_settings_template_request [AccountSettingsTemplateRequest] Request to create an account settings template.
    # @param [Hash] opts the optional parameters
    # @return [AccountSettingsTemplateResponse]
    def update_account_settings_template_version(if_match, template_id, version, authorization, account_settings_template_request, opts = {})
      data, _status_code, _headers = update_account_settings_template_version_with_http_info(if_match, template_id, version, authorization, account_settings_template_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountSettingsTemplateResponse, Integer, Hash)>] AccountSettingsTemplateResponse data, response status code and response headers
    def update_account_settings_template_version_with_http_info(if_match, template_id, version, authorization, account_settings_template_request, opts = {})
      if @api_client.config.debugging
