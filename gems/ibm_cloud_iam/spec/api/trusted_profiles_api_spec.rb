...
# Unit tests for IbmCloudIam::TrustedProfilesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrustedProfilesApi' do
  before do
  ...
  describe 'test an instance of TrustedProfilesApi' do
    it 'should create an instance of TrustedProfilesApi' do
      expect(@api_instance).to be_instance_of(IbmCloudIam::TrustedProfilesApi)
    end
  end
  ...
  # @param profile_id ID of the trusted profile to create a claim rule.
  # @param profile_claim_rule_request Request to create a claim rule for trusted profile.
  ...
  # @param profile_id ID of the trusted profile.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param create_profile_link_request Request to create a Link to Trusted profile.
  # @param [Hash] opts the optional parameters
  # @return [ProfileLink]
  ...
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param create_trusted_profile_request Request to create a trusted profile.
  # @param [Hash] opts the optional parameters
  ...
  # @param profile_id ID of the trusted profile.
  # @param rule_id ID of the claim rule to delete.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # unit tests for delete_link_by_parameters
  ...
  # @param profile_id The unique ID of the Trusted Profile
  # @param type The compute resource type. Valid values are VSI, PVS, BMS, IKS_SA, ROKS_SA, CE
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param [Hash] opts the optional parameters
  ...
  # @return [nil]
  describe 'delete_link_by_parameters test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for delete_profile_identity
  ...
  # @param identifier_id Identifier of the identity that can assume the trusted profiles.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_profile_identity test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param profile_id ID of the trusted profile.
  # @param rule_id ID of the claim rule to get.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param [Hash] opts the optional parameters
  # @return [ProfileClaimRule]
  ...
  # @param profile_id ID of the trusted profile to get.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param [Hash] opts the optional parameters
  ...
  # unit tests for get_profile_identities
  ...
  describe 'get_profile_identities test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_profile_identity
  ...
  describe 'get_profile_identity test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_claim_rules
  ...
  describe 'list_claim_rules test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param account_id Account ID to query for trusted profiles.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param [Hash] opts the optional parameters
  ...
  # unit tests for set_profile_identities
  # Update the list of identities that can assume the trusted profile
  # Update the list of identities that can assume the trusted profile
  # @param profile_id ID of the trusted profile.
  # @param if_match Entity tag of the Identities to be updated. Specify the tag that you retrieved when reading the Profile Identities. This value helps identify parallel usage of this API. Pass * to indicate updating any available version, which may result in stale updates.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param profile_identities_update_request Request to update identities.
  # @param [Hash] opts the optional parameters
  # @return [ProfileIdentitiesResponse]
  describe 'set_profile_identities test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for set_profile_identity
  ...
  # @param identity_type Type of the identity
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param profile_identity_request Request to update identities.
  # @param [Hash] opts the optional parameters
  # @return [ProfileIdentityResponse]
  describe 'set_profile_identity test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param profile_id ID of the trusted profile.
  # @param rule_id ID of the claim rule to update.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param if_match Version of the claim rule to be updated. Specify the version that you retrived when reading list of claim rules. This value helps to identify any parallel usage of claim rule. Pass * to indicate to update any version available. This might result in stale updates. 
  # @param profile_claim_rule_request Request to update a claim rule.
  # @param [Hash] opts the optional parameters
  # @return [ProfileClaimRule]
  ...
  # @param profile_id ID of the trusted profile to be updated.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param if_match Version of the trusted profile to be updated. Specify the version that you retrived when reading list of trusted profiles. This value helps to identify any parallel usage of trusted profile. Pass * to indicate to update any version available. This might result in stale updates. 
  # @param update_trusted_profile_request Request to update a trusted profile.
  # @param [Hash] opts the optional parameters
  # @return [TrustedProfile]
