...
# Unit tests for IbmCloudIam::TrustedProfileTemplateApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrustedProfileTemplateApi' do
  before do
  ...
  describe 'test an instance of TrustedProfileTemplateApi' do
    it 'should create an instance of TrustedProfileTemplateApi' do
      expect(@api_instance).to be_instance_of(IbmCloudIam::TrustedProfileTemplateApi)
    end
  end

  # unit tests for commit_profile_template
  ...
  # @param template_id ID of the trusted profile template
  # @param version Version of the Profile Template
  ...
  # @return [nil]
  describe 'commit_profile_template test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_profile_template
  # Create a trusted profile template
  # Create a new trusted profile template in an enterprise account.
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param trusted_profile_template_request Request to create a trusted profile template.
  # @param [Hash] opts the optional parameters
  # @return [TrustedProfileTemplateResponse]
  describe 'create_profile_template test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_profile_template_version
  ...
  # @param template_id ID of the trusted profile template
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param trusted_profile_template_request Request to create new version of a Trusted Profile Template
  # @param [Hash] opts the optional parameters
  # @return [TrustedProfileTemplateResponse]
  describe 'create_profile_template_version test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_all_versions_of_profile_template
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_all_versions_of_profile_template test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_profile_template_version
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_profile_template_version test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_latest_profile_template_version
  ...
  # @return [TrustedProfileTemplateResponse]
  describe 'get_latest_profile_template_version test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_profile_template_version
  ...
  # @option opts [Boolean] :include_history Defines if the entity history is included in the response
  # @return [TrustedProfileTemplateResponse]
  describe 'get_profile_template_version test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_profile_templates
  ...
  # @option opts [String] :sort Optional sort property. If specified, the returned templates are sorted according to this property.
  ...
  describe 'list_profile_templates test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_versions_of_profile_template
  ...
  # @option opts [String] :include_history Defines if the entity history is included in the response
  # @return [TrustedProfileTemplateList]
  describe 'list_versions_of_profile_template test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_profile_template_version
  ...
  # @param if_match Entity tag of the Template to be updated. Specify the tag that you retrieved when reading the Profile Template. This value helps identifying parallel usage of this API. Pass * to indicate to update any version available. This might result in stale updates. 
  # @param template_id ID of the trusted profile template
  # @param version Version of the Profile Template
  # @param authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @param trusted_profile_template_request Request to create a trusted profile template.
  # @param [Hash] opts the optional parameters
  # @return [TrustedProfileTemplateResponse]
  describe 'update_profile_template_version test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
