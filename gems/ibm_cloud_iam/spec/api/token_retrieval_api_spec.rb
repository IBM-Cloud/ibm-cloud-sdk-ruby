...
# Unit tests for IbmCloudIam::TokenRetrievalApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TokenRetrievalApi' do
  before do
  ...
  describe 'test an instance of TokenRetrievalApi' do
    it 'should create an instance of TokenRetrievalApi' do
      expect(@api_instance).to be_instance_of(IbmCloudIam::TokenRetrievalApi)
    end
  end
  ...
  # unit tests for get_token_assume
  ...
  # @param grant_type Grant type for this API call. You must set the grant type to &#x60;urn:ibm:params:oauth:grant-type:assume&#x60;.
  # @param [Hash] opts the optional parameters
  ...
  # @return [TokenResponse]
  describe 'get_token_assume test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_token_cr_token
  ...
  # @param grant_type Grant type for this API call. You must set the grant type to &#x60;urn:ibm:params:oauth:grant-type:cr-token&#x60;.
  # @param cr_token The value of the Compute Resource token. As this is a JWT token, the string can get very long.
  # @param [Hash] opts the optional parameters
  ...
  # @option opts [String] :profile_crn see &#39;profile_id&#39;
  # @return [TokenResponse]
  describe 'get_token_cr_token test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
