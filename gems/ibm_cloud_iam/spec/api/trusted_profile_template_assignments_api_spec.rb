...
# Unit tests for IbmCloudIam::TrustedProfileTemplateAssignmentsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrustedProfileTemplateAssignmentsApi' do
  before do
  ...
  describe 'test an instance of TrustedProfileTemplateAssignmentsApi' do
    it 'should create an instance of TrustedProfileTemplateAssignmentsApi' do
      expect(@api_instance).to be_instance_of(IbmCloudIam::TrustedProfileTemplateAssignmentsApi)
    end
  end

  # unit tests for create_trusted_profile_assignment
  # Create assignment
  ...
  describe 'create_trusted_profile_assignment test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_trusted_profile_assignment
  # Delete assignment
  ...
  describe 'delete_trusted_profile_assignment test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_trusted_profile_assignment
  # Get assignment
  ...
  # @option opts [String] :authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @return [TemplateAssignmentResponse]
  describe 'get_trusted_profile_assignment test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_trusted_profile_assignments
  # List assignments
  ...
  describe 'list_trusted_profile_assignments test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_trusted_profile_assignment
  # Update assignment
  ...
  # @option opts [String] :authorization Authorization Token used for the request. The supported token type is a Cloud IAM Access Token. If the token is omitted the request will fail with BXNIM0308E: &#39;No authorization header found&#39;. Make sure that the provided token has the required authority for the request.
  # @return [TemplateAssignmentResponse]
  describe 'update_trusted_profile_assignment test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
