...
# Unit tests for IbmCloudIam::ServiceIDsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ServiceIDsApi' do
  before do
  ...
  describe 'test an instance of ServiceIDsApi' do
    it 'should create an instance of ServiceIDsApi' do
      expect(@api_instance).to be_instance_of(IbmCloudIam::ServiceIDsApi)
    end
  end
