...
# Unit tests for IbmCloudIam::TemplateAssignmentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::TemplateAssignmentResponse do
  #let(:instance) { IbmCloudIam::TemplateAssignmentResponse.new }

  describe 'test an instance of TemplateAssignmentResponse' do
    it 'should create an instance of TemplateAssignmentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::TemplateAssignmentResponse)
    end
  end
