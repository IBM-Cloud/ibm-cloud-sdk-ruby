...
describe IbmCloudIam::ApiKey do
  #let(:instance) { IbmCloudIam::ApiKey.new }
  ...
  describe 'test attribute "support_sessions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "action_when_leaked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
