...
# Unit tests for IbmCloudIam::AccountSettingsTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::AccountSettingsTemplateResponse do
  #let(:instance) { IbmCloudIam::AccountSettingsTemplateResponse.new }

  describe 'test an instance of AccountSettingsTemplateResponse' do
    it 'should create an instance of AccountSettingsTemplateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::AccountSettingsTemplateResponse)
    end
  end
