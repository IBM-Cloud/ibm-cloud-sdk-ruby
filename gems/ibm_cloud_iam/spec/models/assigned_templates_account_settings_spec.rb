...
# Unit tests for IbmCloudIam::AssignedTemplatesAccountSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::AssignedTemplatesAccountSettings do
  #let(:instance) { IbmCloudIam::AssignedTemplatesAccountSettings.new }

  describe 'test an instance of AssignedTemplatesAccountSettings' do
    it 'should create an instance of AssignedTemplatesAccountSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::AssignedTemplatesAccountSettings)
    end
  end
