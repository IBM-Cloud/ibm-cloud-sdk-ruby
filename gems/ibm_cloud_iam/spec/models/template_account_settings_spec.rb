...
# Unit tests for IbmCloudIam::TemplateAccountSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::TemplateAccountSettings do
  #let(:instance) { IbmCloudIam::TemplateAccountSettings.new }

  describe 'test an instance of TemplateAccountSettings' do
    it 'should create an instance of TemplateAccountSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::TemplateAccountSettings)
    end
  end
