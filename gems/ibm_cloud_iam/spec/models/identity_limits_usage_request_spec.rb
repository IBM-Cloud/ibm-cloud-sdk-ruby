...
# Unit tests for IbmCloudIam::IdentityLimitsUsageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::IdentityLimitsUsageRequest do
  #let(:instance) { IbmCloudIam::IdentityLimitsUsageRequest.new }

  describe 'test an instance of IdentityLimitsUsageRequest' do
    it 'should create an instance of IdentityLimitsUsageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::IdentityLimitsUsageRequest)
    end
  end
