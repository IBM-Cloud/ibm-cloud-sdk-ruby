...
# Unit tests for IbmCloudIam::TrustedProfileTemplateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::TrustedProfileTemplateResponse do
  #let(:instance) { IbmCloudIam::TrustedProfileTemplateResponse.new }

  describe 'test an instance of TrustedProfileTemplateResponse' do
    it 'should create an instance of TrustedProfileTemplateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::TrustedProfileTemplateResponse)
    end
  end
  ...
  describe 'test attribute "policy_template_references"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "action_controls"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
