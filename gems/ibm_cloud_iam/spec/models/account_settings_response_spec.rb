...
# Unit tests for IbmCloudIam::AccountSettingsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::AccountSettingsResponse do
  #let(:instance) { IbmCloudIam::AccountSettingsResponse.new }

  describe 'test an instance of AccountSettingsResponse' do
    it 'should create an instance of AccountSettingsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::AccountSettingsResponse)
    end
  end
