...
# Unit tests for IbmCloudIam::AccountSettingsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::AccountSettingsRequest do
  #let(:instance) { IbmCloudIam::AccountSettingsRequest.new }

  describe 'test an instance of AccountSettingsRequest' do
    it 'should create an instance of AccountSettingsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::AccountSettingsRequest)
    end
  end
