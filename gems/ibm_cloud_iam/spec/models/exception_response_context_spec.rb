...
# Unit tests for IbmCloudIam::ExceptionResponseContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::ExceptionResponseContext do
  #let(:instance) { IbmCloudIam::ExceptionResponseContext.new }

  describe 'test an instance of ExceptionResponseContext' do
    it 'should create an instance of ExceptionResponseContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::ExceptionResponseContext)
    end
  end
