...
# Unit tests for IbmCloudIam::AccountSettingsEffectiveSection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::AccountSettingsEffectiveSection do
  #let(:instance) { IbmCloudIam::AccountSettingsEffectiveSection.new }

  describe 'test an instance of AccountSettingsEffectiveSection' do
    it 'should create an instance of AccountSettingsEffectiveSection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::AccountSettingsEffectiveSection)
    end
  end
