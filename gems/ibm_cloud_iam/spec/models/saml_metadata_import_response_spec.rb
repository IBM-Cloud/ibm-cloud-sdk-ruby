...
# Unit tests for IbmCloudIam::SamlMetadataImportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::SamlMetadataImportResponse do
  #let(:instance) { IbmCloudIam::SamlMetadataImportResponse.new }

  describe 'test an instance of SamlMetadataImportResponse' do
    it 'should create an instance of SamlMetadataImportResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::SamlMetadataImportResponse)
    end
  end
  ...
  describe 'test attribute "share_scope"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "ui_setup_completed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
