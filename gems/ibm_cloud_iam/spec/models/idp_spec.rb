...
# Unit tests for IbmCloudIam::Idp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudIam::Idp do
  #let(:instance) { IbmCloudIam::Idp.new }

  describe 'test an instance of Idp' do
    it 'should create an instance of Idp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudIam::Idp)
    end
  end
