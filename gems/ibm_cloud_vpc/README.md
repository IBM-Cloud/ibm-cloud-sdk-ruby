...
*IbmCloudVpc::VPCsApi* | [**create_vpc_routing_table_route**](docs/VPCsApi.md#create_vpc_routing_table_route) | **POST** /vpcs/{vpc_id}/routing_tables/{routing_table_id}/routes | Create a VPC route
