  ...
  class InstanceGroupCollection
    ...
    def self.openapi_types
      {
        ...
        :'instance_groups' => :'Array<InstanceGroup>',
        :'limit' => :'Integer',
        :'_next' => :'InstanceGroupCollectionNext',
        :'total_count' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::InstanceGroupCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::InstanceGroupCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'instance_groups')
        if (value = attributes[:'instance_groups']).is_a?(Array)
          self.instance_groups = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @instance_groups.nil?
        invalid_properties.push('invalid value for "instance_groups", instance_groups cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @instance_groups.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          first == o.first &&
          instance_groups == o.instance_groups &&
          limit == o.limit &&
          _next == o._next &&
    ...
    def hash
      [first, instance_groups, limit, _next, total_count].hash
    end
