...
module IbmCloudVpc
  class LoadBalancerPoolPatch
    ...
    def self.openapi_types
      {
        :'algorithm' => :'String',
        :'health_monitor' => :'LoadBalancerPoolHealthMonitorPatch',
        :'name' => :'String',
        :'protocol' => :'String',
        :'session_persistence' => :'LoadBalancerPoolSessionPersistencePatch'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::LoadBalancerPoolPatch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::LoadBalancerPoolPatch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [algorithm, health_monitor, name, protocol, session_persistence].hash
    end
