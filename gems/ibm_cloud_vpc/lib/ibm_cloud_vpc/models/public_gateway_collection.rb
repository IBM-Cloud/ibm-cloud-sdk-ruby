  ...
  class PublicGatewayCollection
    ...
    def self.openapi_types
      {
        ...
        :'limit' => :'Integer',
        :'_next' => :'PublicGatewayCollectionNext',
        :'public_gateways' => :'Array<PublicGateway>',
        :'total_count' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::PublicGatewayCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::PublicGatewayCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'public_gateways')
        if (value = attributes[:'public_gateways']).is_a?(Array)
          self.public_gateways = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @public_gateways.nil?
        invalid_properties.push('invalid value for "public_gateways", public_gateways cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @public_gateways.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          limit == o.limit &&
          _next == o._next &&
          public_gateways == o.public_gateways &&
    ...
    def hash
      [first, limit, _next, public_gateways, total_count].hash
    end
