...
module IbmCloudVpc
  class InstanceGroupMembership
    ...
    attr_accessor :delete_instance_on_membership_delete
    ...
    def self.attribute_map
      {
        :'delete_instance_on_membership_delete' => :'delete_instance_on_membership_delete',
        :'href' => :'href',
        :'id' => :'id',
        :'instance' => :'instance',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::InstanceGroupMembership` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::InstanceGroupMembership`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'delete_instance_on_membership_delete')
        self.delete_instance_on_membership_delete = attributes[:'delete_instance_on_membership_delete']
      end
      ...
      if attributes.key?(:'pool_member')
        self.pool_member = attributes[:'pool_member']
      end
    ...
    def list_invalid_properties
      ...
      if @delete_instance_on_membership_delete.nil?
        invalid_properties.push('invalid value for "delete_instance_on_membership_delete", delete_instance_on_membership_delete cannot be nil.')
      end
    ...
    def valid?
      return false if @delete_instance_on_membership_delete.nil?
      ...
      status_validator = EnumAttributeValidator.new('String', ["deleting", "failed", "healthy", "pending", "unhealthy"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["deleting", "failed", "healthy", "pending", "unhealthy"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          delete_instance_on_membership_delete == o.delete_instance_on_membership_delete &&
          href == o.href &&
          id == o.id &&
          instance == o.instance &&
          instance_template == o.instance_template &&
          name == o.name &&
          pool_member == o.pool_member &&
          status == o.status
    end
    ...
    def hash
      [delete_instance_on_membership_delete, href, id, instance, instance_template, name, pool_member, status].hash
    end
