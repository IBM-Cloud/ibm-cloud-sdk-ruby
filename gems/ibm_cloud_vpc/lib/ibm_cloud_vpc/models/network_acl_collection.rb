  ...
  class NetworkACLCollection
    ...
    def self.openapi_types
      {
        ...
        :'limit' => :'Integer',
        :'network_acls' => :'Array<NetworkACL>',
        :'_next' => :'NetworkACLCollectionNext',
        :'total_count' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::NetworkACLCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::NetworkACLCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'network_acls')
        if (value = attributes[:'network_acls']).is_a?(Array)
          self.network_acls = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @network_acls.nil?
        invalid_properties.push('invalid value for "network_acls", network_acls cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @network_acls.nil?
    ...
    def hash
      [first, limit, network_acls, _next, total_count].hash
    end
