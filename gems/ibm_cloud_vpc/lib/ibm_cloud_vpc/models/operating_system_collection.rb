  ...
  class OperatingSystemCollection
    ...
    def self.openapi_types
      {
        ...
        :'limit' => :'Integer',
        :'_next' => :'OperatingSystemCollectionNext',
        :'operating_systems' => :'Array<OperatingSystem>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::OperatingSystemCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::OperatingSystemCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @operating_systems.nil?
        invalid_properties.push('invalid value for "operating_systems", operating_systems cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @operating_systems.nil?
      true
    end
    ...
    def hash
      [first, limit, _next, operating_systems].hash
    end
