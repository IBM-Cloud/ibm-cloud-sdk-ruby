...
module IbmCloudVpc
  class Image
    ...
    # The minimum size (in gigabytes) of a volume onto which this image may be provisioned.  This property may be absent if the image has a `status` of `pending`, `tentative`, or `failed`.
    attr_accessor :minimum_provisioned_size
    ...
    def self.attribute_map
      {
        ...
        :'href' => :'href',
        :'id' => :'id',
        :'minimum_provisioned_size' => :'minimum_provisioned_size',
        :'name' => :'name',
    ...
    def self.openapi_types
      {
        ...
        :'href' => :'String',
        :'id' => :'String',
        :'minimum_provisioned_size' => :'Integer',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::Image` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::Image`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'minimum_provisioned_size')
        self.minimum_provisioned_size = attributes[:'minimum_provisioned_size']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["available", "deleting", "deprecated", "failed", "pending", "tentative"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["available", "deleting", "deprecated", "failed", "pending", "tentative"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          href == o.href &&
          id == o.id &&
          minimum_provisioned_size == o.minimum_provisioned_size &&
          name == o.name &&
    ...
    def hash
      [created_at, crn, file, href, id, minimum_provisioned_size, name, operating_system, resource_group, status, visibility].hash
    end
