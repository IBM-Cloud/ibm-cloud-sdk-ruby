  ...
  class FlowLogCollector
    ...
    def self.openapi_types
      {
        ...
        :'target' => :'OneOfNetworkInterfaceReferenceTargetContextInstanceReferenceSubnetReferenceVPCReference',
        :'vpc' => :'VPCReference'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::FlowLogCollector` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::FlowLogCollector`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @auto_delete.nil?
        invalid_properties.push('invalid value for "auto_delete", auto_delete cannot be nil.')
      end
      ...
      if @storage_bucket.nil?
        invalid_properties.push('invalid value for "storage_bucket", storage_bucket cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auto_delete.nil?
      ...
      return false if @storage_bucket.nil?
    ...
    def hash
      [active, auto_delete, created_at, crn, href, id, lifecycle_state, name, resource_group, storage_bucket, target, vpc].hash
    end
