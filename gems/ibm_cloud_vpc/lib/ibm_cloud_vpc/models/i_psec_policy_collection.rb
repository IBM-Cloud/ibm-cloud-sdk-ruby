  ...
  class IPsecPolicyCollection
    ...
    def self.openapi_types
      {
        ...
        :'limit' => :'Integer',
        :'_next' => :'IPsecPolicyCollectionNext',
        :'total_count' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::IPsecPolicyCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::IPsecPolicyCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ipsec_policies')
        if (value = attributes[:'ipsec_policies']).is_a?(Array)
          self.ipsec_policies = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @ipsec_policies.nil?
        invalid_properties.push('invalid value for "ipsec_policies", ipsec_policies cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ipsec_policies.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          first == o.first &&
          ipsec_policies == o.ipsec_policies &&
          limit == o.limit &&
          _next == o._next &&
    ...
    def hash
      [first, ipsec_policies, limit, _next, total_count].hash
    end
