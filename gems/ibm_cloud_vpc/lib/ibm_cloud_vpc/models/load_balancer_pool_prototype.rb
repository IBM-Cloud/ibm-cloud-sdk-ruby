...
module IbmCloudVpc
  class LoadBalancerPoolPrototype
    ...
    attr_accessor :health_monitor

    # The members for this load balancer pool. For load balancers in the `network` family, the same `port` and `target` tuple cannot be shared by a member of any other load balancer.
    attr_accessor :members

    # The user-defined name for this load balancer pool. If unspecified, the name will be a hyphenated list of randomly-selected words.
    attr_accessor :name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::LoadBalancerPoolPrototype` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::LoadBalancerPoolPrototype`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'health_monitor')
        self.health_monitor = attributes[:'health_monitor']
      end
      ...
      if attributes.key?(:'session_persistence')
        self.session_persistence = attributes[:'session_persistence']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @health_monitor.nil?
        invalid_properties.push('invalid value for "health_monitor", health_monitor cannot be nil.')
      end
    ...
    def valid?
      ...
      algorithm_validator = EnumAttributeValidator.new('String', ["least_connections", "round_robin", "weighted_round_robin"])
      return false unless algorithm_validator.valid?(@algorithm)
      return false if @health_monitor.nil?
      ...
      protocol_validator = EnumAttributeValidator.new('String', ["http", "tcp", "https"])
    ...
    def algorithm=(algorithm)
      validator = EnumAttributeValidator.new('String', ["least_connections", "round_robin", "weighted_round_robin"])
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ["http", "tcp", "https"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          health_monitor == o.health_monitor &&
          members == o.members &&
          name == o.name &&
          protocol == o.protocol &&
          session_persistence == o.session_persistence
    end
    ...
    def hash
      [algorithm, health_monitor, members, name, protocol, session_persistence].hash
    end
