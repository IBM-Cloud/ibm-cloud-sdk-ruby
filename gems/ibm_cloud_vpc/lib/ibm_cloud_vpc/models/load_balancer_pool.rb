  ...
  class LoadBalancerPool
    ...
    def self.openapi_types
      {
        ...
        :'members' => :'Array<LoadBalancerPoolMemberReference>',
        :'name' => :'String',
        :'protocol' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::LoadBalancerPool` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::LoadBalancerPool`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'instance_group')
        self.instance_group = attributes[:'instance_group']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          href == o.href &&
          id == o.id &&
          instance_group == o.instance_group &&
          members == o.members &&
          name == o.name &&
          protocol == o.protocol &&
    ...
    def hash
      [algorithm, created_at, health_monitor, href, id, instance_group, members, name, protocol, provisioning_status, session_persistence].hash
    end
