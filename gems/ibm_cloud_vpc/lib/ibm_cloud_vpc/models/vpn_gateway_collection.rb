  ...
  class VPNGatewayCollection
    ...
    def self.openapi_types
      {
        ...
        :'limit' => :'Integer',
        :'_next' => :'VPNGatewayCollectionNext',
        :'total_count' => :'Integer',
        :'vpn_gateways' => :'Array<VPNGateway>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::VPNGatewayCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::VPNGatewayCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'vpn_gateways')
        if (value = attributes[:'vpn_gateways']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @vpn_gateways.nil?
        invalid_properties.push('invalid value for "vpn_gateways", vpn_gateways cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vpn_gateways.nil?
      true
    end
    ...
    def hash
      [first, limit, _next, total_count, vpn_gateways].hash
    end
