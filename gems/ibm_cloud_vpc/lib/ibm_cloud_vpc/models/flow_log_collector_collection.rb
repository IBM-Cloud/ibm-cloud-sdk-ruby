...
module IbmCloudVpc
  class FlowLogCollectorCollection
    ...
    attr_accessor :flow_log_collectors
    ...
    def self.openapi_types
      {
        ...
        :'flow_log_collectors' => :'Array<FlowLogCollector>',
        :'limit' => :'Integer',
        :'_next' => :'FlowLogCollectorCollectionNext',
        :'total_count' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::FlowLogCollectorCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::FlowLogCollectorCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'flow_log_collectors')
        if (value = attributes[:'flow_log_collectors']).is_a?(Array)
          self.flow_log_collectors = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @flow_log_collectors.nil?
        invalid_properties.push('invalid value for "flow_log_collectors", flow_log_collectors cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @flow_log_collectors.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          first == o.first &&
          flow_log_collectors == o.flow_log_collectors &&
          limit == o.limit &&
          _next == o._next &&
    ...
    def hash
      [first, flow_log_collectors, limit, _next, total_count].hash
    end
