...
module IbmCloudVpc
  class VolumeAttachmentReferenceVolumeContext
    ...
    attr_accessor :delete_volume_on_instance_delete
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudVpc::VolumeAttachmentReferenceVolumeContext` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudVpc::VolumeAttachmentReferenceVolumeContext`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'delete_volume_on_instance_delete')
        self.delete_volume_on_instance_delete = attributes[:'delete_volume_on_instance_delete']
      end
    ...
    def list_invalid_properties
      ...
      if @delete_volume_on_instance_delete.nil?
        invalid_properties.push('invalid value for "delete_volume_on_instance_delete", delete_volume_on_instance_delete cannot be nil.')
      end
    ...
    def valid?
      return false if @delete_volume_on_instance_delete.nil?
      ...
      type_validator = EnumAttributeValidator.new('String', ["boot", "data"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["boot", "data"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          delete_volume_on_instance_delete == o.delete_volume_on_instance_delete &&
          device == o.device &&
          href == o.href &&
          id == o.id &&
          instance == o.instance &&
    ...
    def hash
      [delete_volume_on_instance_delete, device, href, id, instance, name, type].hash
    end
