...
# Unit tests for IbmCloudVpc::Image
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Image' do
  before do
    # run before each test
    @instance = IbmCloudVpc::Image.new
  end
  ...
  describe 'test an instance of Image' do
    it 'should create an instance of Image' do
      expect(@instance).to be_instance_of(IbmCloudVpc::Image)
    end
  end
  ...
  describe 'test attribute "encryption"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "user_managed"])
  ...
  describe 'test attribute "minimum_provisioned_size"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["available", "deleting", "deprecated", "failed", "unusable", "pending", "tentative"])
      # validator.allowable_values.each do |value|
