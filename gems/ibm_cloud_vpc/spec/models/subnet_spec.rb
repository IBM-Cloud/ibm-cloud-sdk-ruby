...
# Unit tests for IbmCloudVpc::Subnet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Subnet' do
  before do
    # run before each test
    @instance = IbmCloudVpc::Subnet.new
  end
  ...
  describe 'test an instance of Subnet' do
    it 'should create an instance of Subnet' do
      expect(@instance).to be_instance_of(IbmCloudVpc::Subnet)
    end
  end
  describe 'test attribute "available_ipv4_address_count"' do
    it 'should work' do
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["available", "deleting", "failed", "pending"])
      # validator.allowable_values.each do |value|
