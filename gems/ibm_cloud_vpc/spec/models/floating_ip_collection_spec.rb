...
# Unit tests for IbmCloudVpc::FloatingIPCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FloatingIPCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::FloatingIPCollection.new
  end
  ...
  describe 'test an instance of FloatingIPCollection' do
    it 'should create an instance of FloatingIPCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::FloatingIPCollection)
    end
  end
