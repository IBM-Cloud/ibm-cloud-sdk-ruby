...
# Unit tests for IbmCloudVpc::FlowLogCollector
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FlowLogCollector' do
  before do
    # run before each test
    @instance = IbmCloudVpc::FlowLogCollector.new
  end
  ...
  describe 'test an instance of FlowLogCollector' do
    it 'should create an instance of FlowLogCollector' do
      expect(@instance).to be_instance_of(IbmCloudVpc::FlowLogCollector)
    end
  end
