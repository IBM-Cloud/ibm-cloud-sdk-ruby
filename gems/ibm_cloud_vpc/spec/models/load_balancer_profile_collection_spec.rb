...
# Unit tests for IbmCloudVpc::LoadBalancerProfileCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LoadBalancerProfileCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::LoadBalancerProfileCollection.new
  end
  ...
  describe 'test an instance of LoadBalancerProfileCollection' do
    it 'should create an instance of LoadBalancerProfileCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::LoadBalancerProfileCollection)
    end
  end
