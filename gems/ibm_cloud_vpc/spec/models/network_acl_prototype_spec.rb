...
# Unit tests for IbmCloudVpc::NetworkACLPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACLPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkACLPrototype.new
  end
  ...
  describe 'test an instance of NetworkACLPrototype' do
    it 'should create an instance of NetworkACLPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACLPrototype)
    end
  end
