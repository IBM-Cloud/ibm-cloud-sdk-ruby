...
# Unit tests for IbmCloudVpc::ZoneReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ZoneReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ZoneReference.new
  end
  ...
  describe 'test an instance of ZoneReference' do
    it 'should create an instance of ZoneReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ZoneReference)
    end
  end
