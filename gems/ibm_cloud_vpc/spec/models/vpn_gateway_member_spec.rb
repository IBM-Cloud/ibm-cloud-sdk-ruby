...
# Unit tests for IbmCloudVpc::VPNGatewayMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPNGatewayMember' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPNGatewayMember.new
  end
  ...
  describe 'test an instance of VPNGatewayMember' do
    it 'should create an instance of VPNGatewayMember' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPNGatewayMember)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["available", "failed", "pending", "deleting"])
      # validator.allowable_values.each do |value|
