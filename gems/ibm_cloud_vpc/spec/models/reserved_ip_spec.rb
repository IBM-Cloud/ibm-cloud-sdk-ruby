...
# Unit tests for IbmCloudVpc::ReservedIP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIP' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ReservedIP.new
  end
  ...
  describe 'test an instance of ReservedIP' do
    it 'should create an instance of ReservedIP' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIP)
    end
  end
  ...
  describe 'test attribute "owner"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["provider", "user"])
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["subnet_reserved_ip"])
      # validator.allowable_values.each do |value|
