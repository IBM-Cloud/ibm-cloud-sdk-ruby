...
# Unit tests for IbmCloudVpc::AddressPrefixPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AddressPrefixPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::AddressPrefixPrototype.new
  end
  ...
  describe 'test an instance of AddressPrefixPrototype' do
    it 'should create an instance of AddressPrefixPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::AddressPrefixPrototype)
    end
  end
