...
# Unit tests for IbmCloudVpc::RoutePatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoutePatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RoutePatch.new
  end
  ...
  describe 'test an instance of RoutePatch' do
    it 'should create an instance of RoutePatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RoutePatch)
    end
  end
