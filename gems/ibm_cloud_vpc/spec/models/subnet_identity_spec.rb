...
# Unit tests for IbmCloudVpc::SubnetIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SubnetIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SubnetIdentity.new
  end
  ...
  describe 'test an instance of SubnetIdentity' do
    it 'should create an instance of SubnetIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SubnetIdentity)
    end
  end
