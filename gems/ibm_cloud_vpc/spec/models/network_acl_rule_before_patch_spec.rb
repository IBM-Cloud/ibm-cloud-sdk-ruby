...
# Unit tests for IbmCloudVpc::NetworkACLRuleBeforePatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACLRuleBeforePatch' do
  before do
  ...
  describe 'test an instance of NetworkACLRuleBeforePatch' do
    it 'should create an instance of NetworkACLRuleBeforePatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACLRuleBeforePatch)
    end
  end
end
