...
# Unit tests for IbmCloudVpc::NetworkInterfaceCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkInterfaceCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkInterfaceCollection.new
  end
  ...
  describe 'test an instance of NetworkInterfaceCollection' do
    it 'should create an instance of NetworkInterfaceCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkInterfaceCollection)
    end
  end
