...
# Unit tests for IbmCloudVpc::IPsecPolicyPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IPsecPolicyPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::IPsecPolicyPrototype.new
  end
  ...
  describe 'test an instance of IPsecPolicyPrototype' do
    it 'should create an instance of IPsecPolicyPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::IPsecPolicyPrototype)
    end
  end
