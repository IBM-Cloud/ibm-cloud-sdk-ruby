...
# Unit tests for IbmCloudVpc::PageLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PageLink' do
  before do
    # run before each test
    @instance = IbmCloudVpc::PageLink.new
  end
  ...
  describe 'test an instance of PageLink' do
    it 'should create an instance of PageLink' do
      expect(@instance).to be_instance_of(IbmCloudVpc::PageLink)
    end
  end
