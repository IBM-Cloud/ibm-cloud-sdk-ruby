...
# Unit tests for IbmCloudVpc::ReservedIPPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIPPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ReservedIPPrototype.new
  end
  ...
  describe 'test an instance of ReservedIPPrototype' do
    it 'should create an instance of ReservedIPPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIPPrototype)
    end
  end
