...
# Unit tests for IbmCloudVpc::Key
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Key' do
  before do
    # run before each test
    @instance = IbmCloudVpc::Key.new
  end
  ...
  describe 'test an instance of Key' do
    it 'should create an instance of Key' do
      expect(@instance).to be_instance_of(IbmCloudVpc::Key)
    end
  end
  ...
  describe 'test attribute "length"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [2048, 4096])
      # validator.allowable_values.each do |value|
      #   expect { @instance.length = value }.not_to raise_error
      # end
    end
  end
