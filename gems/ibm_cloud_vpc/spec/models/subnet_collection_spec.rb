...
# Unit tests for IbmCloudVpc::SubnetCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SubnetCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SubnetCollection.new
  end
  ...
  describe 'test an instance of SubnetCollection' do
    it 'should create an instance of SubnetCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SubnetCollection)
    end
  end
