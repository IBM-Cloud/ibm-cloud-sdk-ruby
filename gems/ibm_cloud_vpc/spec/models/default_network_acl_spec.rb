...
# Unit tests for IbmCloudVpc::DefaultNetworkACL
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DefaultNetworkACL' do
  before do
    # run before each test
    @instance = IbmCloudVpc::DefaultNetworkACL.new
  end
  ...
  describe 'test an instance of DefaultNetworkACL' do
    it 'should create an instance of DefaultNetworkACL' do
      expect(@instance).to be_instance_of(IbmCloudVpc::DefaultNetworkACL)
    end
  end
