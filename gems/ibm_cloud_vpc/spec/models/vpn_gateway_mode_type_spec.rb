...
# Unit tests for IbmCloudVpc::VPNGatewayModeType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPNGatewayModeType' do
  before do
  ...
  describe 'test an instance of VPNGatewayModeType' do
    it 'should create an instance of VPNGatewayModeType' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPNGatewayModeType)
    end
  end
end
