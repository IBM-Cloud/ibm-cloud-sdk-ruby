...
# Unit tests for IbmCloudVpc::KeyIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'KeyIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::KeyIdentity.new
  end
  ...
  describe 'test an instance of KeyIdentity' do
    it 'should create an instance of KeyIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::KeyIdentity)
    end
  end
