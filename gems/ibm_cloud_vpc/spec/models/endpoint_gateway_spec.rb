...
# Unit tests for IbmCloudVpc::EndpointGateway
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EndpointGateway' do
  before do
    # run before each test
    @instance = IbmCloudVpc::EndpointGateway.new
  end
  ...
  describe 'test an instance of EndpointGateway' do
    it 'should create an instance of EndpointGateway' do
      expect(@instance).to be_instance_of(IbmCloudVpc::EndpointGateway)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["endpoint_gateway"])
  ...
  describe 'test attribute "service_endpoint"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "service_endpoints"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
