...
# Unit tests for IbmCloudVpc::FloatingIPIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FloatingIPIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::FloatingIPIdentity.new
  end
  ...
  describe 'test an instance of FloatingIPIdentity' do
    it 'should create an instance of FloatingIPIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::FloatingIPIdentity)
    end
  end
