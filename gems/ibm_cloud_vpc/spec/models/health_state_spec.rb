...
# Unit tests for IbmCloudVpc::HealthState
...
describe 'HealthState' do
  ...
  describe 'test an instance of HealthState' do
    it 'should create an instance of HealthState' do
      expect(@instance).to be_instance_of(IbmCloudVpc::HealthState)
    end
  end
end
