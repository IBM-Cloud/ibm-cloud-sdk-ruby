...
# Unit tests for IbmCloudVpc::NetworkInterfaceReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkInterfaceReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkInterfaceReference.new
  end
  ...
  describe 'test an instance of NetworkInterfaceReference' do
    it 'should create an instance of NetworkInterfaceReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkInterfaceReference)
    end
  end
