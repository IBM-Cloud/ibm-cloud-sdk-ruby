...
# Unit tests for IbmCloudVpc::EndpointGatewayReservedIP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EndpointGatewayReservedIP' do
  before do
    # run before each test
    @instance = IbmCloudVpc::EndpointGatewayReservedIP.new
  end
  ...
  describe 'test an instance of EndpointGatewayReservedIP' do
    it 'should create an instance of EndpointGatewayReservedIP' do
      expect(@instance).to be_instance_of(IbmCloudVpc::EndpointGatewayReservedIP)
    end
  end
