...
# Unit tests for IbmCloudVpc::Deleted
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Deleted' do
  before do
    # run before each test
    @instance = IbmCloudVpc::Deleted.new
  end
  ...
  describe 'test an instance of Deleted' do
    it 'should create an instance of Deleted' do
      expect(@instance).to be_instance_of(IbmCloudVpc::Deleted)
    end
  end
