...
# Unit tests for IbmCloudVpc::InstanceTemplateCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceTemplateCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceTemplateCollection.new
  end
  ...
  describe 'test an instance of InstanceTemplateCollection' do
    it 'should create an instance of InstanceTemplateCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceTemplateCollection)
    end
  end
