...
# Unit tests for IbmCloudVpc::InstanceGroupReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceGroupReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceGroupReference.new
  end
  ...
  describe 'test an instance of InstanceGroupReference' do
    it 'should create an instance of InstanceGroupReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceGroupReference)
    end
  end
