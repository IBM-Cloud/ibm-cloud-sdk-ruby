...
# Unit tests for IbmCloudVpc::RouteReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RouteReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RouteReference.new
  end
  ...
  describe 'test an instance of RouteReference' do
    it 'should create an instance of RouteReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RouteReference)
    end
  end
