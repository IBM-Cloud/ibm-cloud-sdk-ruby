...
# Unit tests for IbmCloudVpc::ReservedIPTargetPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIPTargetPrototype' do
  before do
  ...
  describe 'test an instance of ReservedIPTargetPrototype' do
    it 'should create an instance of ReservedIPTargetPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIPTargetPrototype)
    end
  end
end
