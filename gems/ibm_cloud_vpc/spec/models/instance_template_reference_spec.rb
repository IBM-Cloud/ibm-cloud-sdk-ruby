...
# Unit tests for IbmCloudVpc::InstanceTemplateReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceTemplateReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceTemplateReference.new
  end
  ...
  describe 'test an instance of InstanceTemplateReference' do
    it 'should create an instance of InstanceTemplateReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceTemplateReference)
    end
  end
