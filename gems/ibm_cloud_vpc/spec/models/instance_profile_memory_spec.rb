...
# Unit tests for IbmCloudVpc::InstanceProfileMemory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceProfileMemory' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceProfileMemory.new
  end
  ...
  describe 'test an instance of InstanceProfileMemory' do
    it 'should create an instance of InstanceProfileMemory' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceProfileMemory)
    end
  end
