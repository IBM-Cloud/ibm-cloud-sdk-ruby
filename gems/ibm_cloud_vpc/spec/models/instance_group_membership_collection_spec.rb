...
# Unit tests for IbmCloudVpc::InstanceGroupMembershipCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceGroupMembershipCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceGroupMembershipCollection.new
  end
  ...
  describe 'test an instance of InstanceGroupMembershipCollection' do
    it 'should create an instance of InstanceGroupMembershipCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceGroupMembershipCollection)
    end
  end
