...
# Unit tests for IbmCloudVpc::LoadBalancerListener
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LoadBalancerListener' do
  before do
    # run before each test
    @instance = IbmCloudVpc::LoadBalancerListener.new
  end
  ...
  describe 'test an instance of LoadBalancerListener' do
    it 'should create an instance of LoadBalancerListener' do
      expect(@instance).to be_instance_of(IbmCloudVpc::LoadBalancerListener)
    end
  end
