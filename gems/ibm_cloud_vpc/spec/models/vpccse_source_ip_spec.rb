...
# Unit tests for IbmCloudVpc::VPCCSESourceIP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPCCSESourceIP' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPCCSESourceIP.new
  end
  ...
  describe 'test an instance of VPCCSESourceIP' do
    it 'should create an instance of VPCCSESourceIP' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPCCSESourceIP)
    end
  end
