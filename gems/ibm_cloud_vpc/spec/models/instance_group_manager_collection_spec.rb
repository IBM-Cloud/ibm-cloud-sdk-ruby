...
# Unit tests for IbmCloudVpc::InstanceGroupManagerCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceGroupManagerCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceGroupManagerCollection.new
  end
  ...
  describe 'test an instance of InstanceGroupManagerCollection' do
    it 'should create an instance of InstanceGroupManagerCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceGroupManagerCollection)
    end
  end
