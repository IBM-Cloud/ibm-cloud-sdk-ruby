...
# Unit tests for IbmCloudVpc::VolumeProfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VolumeProfile' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VolumeProfile.new
  end
  ...
  describe 'test an instance of VolumeProfile' do
    it 'should create an instance of VolumeProfile' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VolumeProfile)
    end
  end
