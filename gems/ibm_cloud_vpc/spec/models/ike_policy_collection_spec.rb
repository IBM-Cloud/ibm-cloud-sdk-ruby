...
# Unit tests for IbmCloudVpc::IKEPolicyCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IKEPolicyCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::IKEPolicyCollection.new
  end
  ...
  describe 'test an instance of IKEPolicyCollection' do
    it 'should create an instance of IKEPolicyCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::IKEPolicyCollection)
    end
  end
  ...
  describe 'test attribute "ike_policies"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
