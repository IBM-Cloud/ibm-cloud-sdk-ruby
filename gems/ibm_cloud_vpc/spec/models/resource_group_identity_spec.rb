...
# Unit tests for IbmCloudVpc::ResourceGroupIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ResourceGroupIdentity' do
  before do
  ...
  describe 'test an instance of ResourceGroupIdentity' do
    it 'should create an instance of ResourceGroupIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ResourceGroupIdentity)
    end
  end
end
