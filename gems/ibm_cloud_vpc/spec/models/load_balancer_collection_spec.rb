...
# Unit tests for IbmCloudVpc::LoadBalancerCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LoadBalancerCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::LoadBalancerCollection.new
  end
  ...
  describe 'test an instance of LoadBalancerCollection' do
    it 'should create an instance of LoadBalancerCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::LoadBalancerCollection)
    end
  end
