...
# Unit tests for IbmCloudVpc::ReservedIPCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIPCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ReservedIPCollection.new
  end
  ...
  describe 'test an instance of ReservedIPCollection' do
    it 'should create an instance of ReservedIPCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIPCollection)
    end
  end
  ...
  describe 'test attribute "reserved_ips"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
