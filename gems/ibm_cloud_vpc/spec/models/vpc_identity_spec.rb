...
# Unit tests for IbmCloudVpc::VPCIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPCIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPCIdentity.new
  end
  ...
  describe 'test an instance of VPCIdentity' do
    it 'should create an instance of VPCIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPCIdentity)
    end
  end
