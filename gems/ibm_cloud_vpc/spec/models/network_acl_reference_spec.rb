...
# Unit tests for IbmCloudVpc::NetworkACLReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACLReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkACLReference.new
  end
  ...
  describe 'test an instance of NetworkACLReference' do
    it 'should create an instance of NetworkACLReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACLReference)
    end
  end
