...
# Unit tests for IbmCloudVpc::SecurityGroupPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SecurityGroupPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SecurityGroupPrototype.new
  end
  ...
  describe 'test an instance of SecurityGroupPrototype' do
    it 'should create an instance of SecurityGroupPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SecurityGroupPrototype)
    end
  end
