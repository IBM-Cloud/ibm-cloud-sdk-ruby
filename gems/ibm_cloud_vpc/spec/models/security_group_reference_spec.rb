...
# Unit tests for IbmCloudVpc::SecurityGroupReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SecurityGroupReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SecurityGroupReference.new
  end
  ...
  describe 'test an instance of SecurityGroupReference' do
    it 'should create an instance of SecurityGroupReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SecurityGroupReference)
    end
  end
