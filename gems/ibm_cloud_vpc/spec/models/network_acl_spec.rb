...
# Unit tests for IbmCloudVpc::NetworkACL
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACL' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkACL.new
  end
  ...
  describe 'test an instance of NetworkACL' do
    it 'should create an instance of NetworkACL' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACL)
    end
  end
