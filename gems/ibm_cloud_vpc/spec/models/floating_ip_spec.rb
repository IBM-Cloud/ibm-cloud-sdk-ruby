...
# Unit tests for IbmCloudVpc::FloatingIP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FloatingIP' do
  before do
    # run before each test
    @instance = IbmCloudVpc::FloatingIP.new
  end
  ...
  describe 'test an instance of FloatingIP' do
    it 'should create an instance of FloatingIP' do
      expect(@instance).to be_instance_of(IbmCloudVpc::FloatingIP)
    end
  end
