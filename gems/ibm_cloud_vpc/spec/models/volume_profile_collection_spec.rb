...
# Unit tests for IbmCloudVpc::VolumeProfileCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VolumeProfileCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VolumeProfileCollection.new
  end
  ...
  describe 'test an instance of VolumeProfileCollection' do
    it 'should create an instance of VolumeProfileCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VolumeProfileCollection)
    end
  end
