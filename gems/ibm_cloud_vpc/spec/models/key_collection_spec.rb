...
# Unit tests for IbmCloudVpc::KeyCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'KeyCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::KeyCollection.new
  end
  ...
  describe 'test an instance of KeyCollection' do
    it 'should create an instance of KeyCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::KeyCollection)
    end
  end
