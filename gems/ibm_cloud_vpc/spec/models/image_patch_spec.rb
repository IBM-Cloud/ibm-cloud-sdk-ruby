...
# Unit tests for IbmCloudVpc::ImagePatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ImagePatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ImagePatch.new
  end
  ...
  describe 'test an instance of ImagePatch' do
    it 'should create an instance of ImagePatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ImagePatch)
    end
  end
