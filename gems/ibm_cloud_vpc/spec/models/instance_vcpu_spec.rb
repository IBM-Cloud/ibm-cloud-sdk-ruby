...
# Unit tests for IbmCloudVpc::InstanceVCPU
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceVCPU' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceVCPU.new
  end
  ...
  describe 'test an instance of InstanceVCPU' do
    it 'should create an instance of InstanceVCPU' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceVCPU)
    end
  end
