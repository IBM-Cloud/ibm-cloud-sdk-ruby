...
# Unit tests for IbmCloudVpc::InstanceCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceCollection.new
  end
  ...
  describe 'test an instance of InstanceCollection' do
    it 'should create an instance of InstanceCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceCollection)
    end
  end
