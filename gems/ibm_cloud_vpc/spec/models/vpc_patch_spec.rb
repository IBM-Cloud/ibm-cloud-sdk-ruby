...
# Unit tests for IbmCloudVpc::VPCPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPCPatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPCPatch.new
  end
  ...
  describe 'test an instance of VPCPatch' do
    it 'should create an instance of VPCPatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPCPatch)
    end
  end
