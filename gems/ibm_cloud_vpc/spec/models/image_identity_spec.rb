...
# Unit tests for IbmCloudVpc::ImageIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ImageIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ImageIdentity.new
  end
  ...
  describe 'test an instance of ImageIdentity' do
    it 'should create an instance of ImageIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ImageIdentity)
    end
  end
