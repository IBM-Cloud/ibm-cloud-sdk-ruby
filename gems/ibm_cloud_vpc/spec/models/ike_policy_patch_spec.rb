...
# Unit tests for IbmCloudVpc::IKEPolicyPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IKEPolicyPatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::IKEPolicyPatch.new
  end
  ...
  describe 'test an instance of IKEPolicyPatch' do
    it 'should create an instance of IKEPolicyPatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::IKEPolicyPatch)
    end
  end
