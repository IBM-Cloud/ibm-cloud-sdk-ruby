...
# Unit tests for IbmCloudVpc::VPNGatewayPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPNGatewayPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPNGatewayPrototype.new
  end
  ...
  describe 'test an instance of VPNGatewayPrototype' do
    it 'should create an instance of VPNGatewayPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPNGatewayPrototype)
    end
  end
