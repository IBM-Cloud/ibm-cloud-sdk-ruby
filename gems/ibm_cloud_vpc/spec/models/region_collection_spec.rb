...
# Unit tests for IbmCloudVpc::RegionCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RegionCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RegionCollection.new
  end
  ...
  describe 'test an instance of RegionCollection' do
    it 'should create an instance of RegionCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RegionCollection)
    end
  end
