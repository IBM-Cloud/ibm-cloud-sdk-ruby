...
# Unit tests for IbmCloudVpc::ReservedIPReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIPReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ReservedIPReference.new
  end
  ...
  describe 'test an instance of ReservedIPReference' do
    it 'should create an instance of ReservedIPReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIPReference)
    end
  end
