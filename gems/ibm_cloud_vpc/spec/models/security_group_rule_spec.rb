...
# Unit tests for IbmCloudVpc::SecurityGroupRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SecurityGroupRule' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SecurityGroupRule.new
  end
  ...
  describe 'test an instance of SecurityGroupRule' do
    it 'should create an instance of SecurityGroupRule' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SecurityGroupRule)
    end
  end
