...
# Unit tests for IbmCloudVpc::NetworkACLCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACLCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkACLCollection.new
  end
  ...
  describe 'test an instance of NetworkACLCollection' do
    it 'should create an instance of NetworkACLCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACLCollection)
    end
  end
  ...
  describe 'test attribute "network_acls"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
