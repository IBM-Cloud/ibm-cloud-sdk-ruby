...
# Unit tests for IbmCloudVpc::RoutingTableReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoutingTableReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RoutingTableReference.new
  end
  ...
  describe 'test an instance of RoutingTableReference' do
    it 'should create an instance of RoutingTableReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RoutingTableReference)
    end
  end
