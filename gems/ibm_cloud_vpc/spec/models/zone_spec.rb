...
# Unit tests for IbmCloudVpc::Zone
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Zone' do
  before do
    # run before each test
    @instance = IbmCloudVpc::Zone.new
  end
  ...
  describe 'test an instance of Zone' do
    it 'should create an instance of Zone' do
      expect(@instance).to be_instance_of(IbmCloudVpc::Zone)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["available", "impaired", "unavailable"])
