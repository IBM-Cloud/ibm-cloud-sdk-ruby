...
# Unit tests for IbmCloudVpc::ZoneIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ZoneIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ZoneIdentity.new
  end
  ...
  describe 'test an instance of ZoneIdentity' do
    it 'should create an instance of ZoneIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ZoneIdentity)
    end
  end
