...
# Unit tests for IbmCloudVpc::VolumePrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VolumePrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VolumePrototype.new
  end
  ...
  describe 'test an instance of VolumePrototype' do
    it 'should create an instance of VolumePrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VolumePrototype)
    end
  end
