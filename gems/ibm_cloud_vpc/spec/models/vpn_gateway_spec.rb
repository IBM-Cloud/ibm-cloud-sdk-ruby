...
# Unit tests for IbmCloudVpc::VPNGateway
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPNGateway' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPNGateway.new
  end
  ...
  describe 'test an instance of VPNGateway' do
    it 'should create an instance of VPNGateway' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPNGateway)
    end
  end
  ...
  describe 'test attribute "resource_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["vpn_gateway"])
