...
# Unit tests for IbmCloudVpc::FlowLogCollectorTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FlowLogCollectorTarget' do
  before do
    # run before each test
    @instance = IbmCloudVpc::FlowLogCollectorTarget.new
  end
  ...
  describe 'test an instance of FlowLogCollectorTarget' do
    it 'should create an instance of FlowLogCollectorTarget' do
      expect(@instance).to be_instance_of(IbmCloudVpc::FlowLogCollectorTarget)
    end
  end
