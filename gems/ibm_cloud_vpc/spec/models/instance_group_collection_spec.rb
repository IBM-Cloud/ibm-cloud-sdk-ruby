...
# Unit tests for IbmCloudVpc::InstanceGroupCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceGroupCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceGroupCollection.new
  end
  ...
  describe 'test an instance of InstanceGroupCollection' do
    it 'should create an instance of InstanceGroupCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceGroupCollection)
    end
  end
  ...
  describe 'test attribute "instance_groups"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
