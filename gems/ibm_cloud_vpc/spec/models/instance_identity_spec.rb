...
# Unit tests for IbmCloudVpc::InstanceIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceIdentity.new
  end
  ...
  describe 'test an instance of InstanceIdentity' do
    it 'should create an instance of InstanceIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceIdentity)
    end
  end
