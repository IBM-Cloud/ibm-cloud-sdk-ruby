...
# Unit tests for IbmCloudVpc::FloatingIPPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FloatingIPPatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::FloatingIPPatch.new
  end
  ...
  describe 'test an instance of FloatingIPPatch' do
    it 'should create an instance of FloatingIPPatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::FloatingIPPatch)
    end
  end
