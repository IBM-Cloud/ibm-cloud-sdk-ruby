...
# Unit tests for IbmCloudVpc::RouteNextHopIP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RouteNextHopIP' do
  before do
  ...
  describe 'test an instance of RouteNextHopIP' do
    it 'should create an instance of RouteNextHopIP' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RouteNextHopIP)
    end
  end
end
