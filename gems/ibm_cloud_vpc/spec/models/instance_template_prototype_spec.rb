...
# Unit tests for IbmCloudVpc::InstanceTemplatePrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceTemplatePrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceTemplatePrototype.new
  end
  ...
  describe 'test an instance of InstanceTemplatePrototype' do
    it 'should create an instance of InstanceTemplatePrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceTemplatePrototype)
    end
  end
