...
# Unit tests for IbmCloudVpc::RegionReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RegionReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RegionReference.new
  end
  ...
  describe 'test an instance of RegionReference' do
    it 'should create an instance of RegionReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RegionReference)
    end
  end
