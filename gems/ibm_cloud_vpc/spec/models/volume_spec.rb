...
# Unit tests for IbmCloudVpc::Volume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Volume' do
  before do
    # run before each test
    @instance = IbmCloudVpc::Volume.new
  end
  ...
  describe 'test an instance of Volume' do
    it 'should create an instance of Volume' do
      expect(@instance).to be_instance_of(IbmCloudVpc::Volume)
    end
  end
  ...
  describe 'test attribute "encryption"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["provider_managed", "user_managed"])
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["available", "failed", "pending", "unusable", "pending_deletion"])
      # validator.allowable_values.each do |value|
