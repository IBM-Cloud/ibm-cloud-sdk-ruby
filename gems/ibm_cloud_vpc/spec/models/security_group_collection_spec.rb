...
# Unit tests for IbmCloudVpc::SecurityGroupCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SecurityGroupCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SecurityGroupCollection.new
  end
  ...
  describe 'test an instance of SecurityGroupCollection' do
    it 'should create an instance of SecurityGroupCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SecurityGroupCollection)
    end
  end
