...
# Unit tests for IbmCloudVpc::PublicGateway
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PublicGateway' do
  before do
    # run before each test
    @instance = IbmCloudVpc::PublicGateway.new
  end
  ...
  describe 'test an instance of PublicGateway' do
    it 'should create an instance of PublicGateway' do
      expect(@instance).to be_instance_of(IbmCloudVpc::PublicGateway)
    end
  end
