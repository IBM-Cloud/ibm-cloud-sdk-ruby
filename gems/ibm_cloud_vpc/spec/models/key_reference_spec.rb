...
# Unit tests for IbmCloudVpc::KeyReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'KeyReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::KeyReference.new
  end
  ...
  describe 'test an instance of KeyReference' do
    it 'should create an instance of KeyReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::KeyReference)
    end
  end
