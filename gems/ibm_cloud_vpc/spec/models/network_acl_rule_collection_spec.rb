...
# Unit tests for IbmCloudVpc::NetworkACLRuleCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACLRuleCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkACLRuleCollection.new
  end
  ...
  describe 'test an instance of NetworkACLRuleCollection' do
    it 'should create an instance of NetworkACLRuleCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACLRuleCollection)
    end
  end
