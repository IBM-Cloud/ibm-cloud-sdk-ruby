...
# Unit tests for IbmCloudVpc::InstanceReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceReference.new
  end
  ...
  describe 'test an instance of InstanceReference' do
    it 'should create an instance of InstanceReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceReference)
    end
  end
