...
# Unit tests for IbmCloudVpc::InstanceTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceTemplate' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceTemplate.new
  end
  ...
  describe 'test an instance of InstanceTemplate' do
    it 'should create an instance of InstanceTemplate' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceTemplate)
    end
  end
