...
# Unit tests for IbmCloudVpc::VolumeCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VolumeCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VolumeCollection.new
  end
  ...
  describe 'test an instance of VolumeCollection' do
    it 'should create an instance of VolumeCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VolumeCollection)
    end
  end
