...
# Unit tests for IbmCloudVpc::ImagePrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ImagePrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ImagePrototype.new
  end
  ...
  describe 'test an instance of ImagePrototype' do
    it 'should create an instance of ImagePrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ImagePrototype)
    end
  end
