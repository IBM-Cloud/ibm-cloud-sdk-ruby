...
# Unit tests for IbmCloudVpc::EncryptionKeyIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EncryptionKeyIdentity' do
  before do
  ...
  describe 'test an instance of EncryptionKeyIdentity' do
    it 'should create an instance of EncryptionKeyIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::EncryptionKeyIdentity)
    end
  end
end
