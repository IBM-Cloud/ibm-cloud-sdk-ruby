...
# Unit tests for IbmCloudVpc::NetworkACLRuleItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkACLRuleItem' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkACLRuleItem.new
  end
  ...
  describe 'test an instance of NetworkACLRuleItem' do
    it 'should create an instance of NetworkACLRuleItem' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkACLRuleItem)
    end
  end
