...
# Unit tests for IbmCloudVpc::VolumeIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VolumeIdentity' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VolumeIdentity.new
  end
  ...
  describe 'test an instance of VolumeIdentity' do
    it 'should create an instance of VolumeIdentity' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VolumeIdentity)
    end
  end
