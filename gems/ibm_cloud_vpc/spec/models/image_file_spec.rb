...
# Unit tests for IbmCloudVpc::ImageFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ImageFile' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ImageFile.new
  end
  ...
  describe 'test an instance of ImageFile' do
    it 'should create an instance of ImageFile' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ImageFile)
    end
  end
