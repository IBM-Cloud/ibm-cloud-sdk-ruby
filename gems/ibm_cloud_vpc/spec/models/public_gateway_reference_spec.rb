...
# Unit tests for IbmCloudVpc::PublicGatewayReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PublicGatewayReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::PublicGatewayReference.new
  end
  ...
  describe 'test an instance of PublicGatewayReference' do
    it 'should create an instance of PublicGatewayReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::PublicGatewayReference)
    end
  end
