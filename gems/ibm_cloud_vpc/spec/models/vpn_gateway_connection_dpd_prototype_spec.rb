...
# Unit tests for IbmCloudVpc::VPNGatewayConnectionDPDPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPNGatewayConnectionDPDPrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPNGatewayConnectionDPDPrototype.new
  end
  ...
  describe 'test an instance of VPNGatewayConnectionDPDPrototype' do
    it 'should create an instance of VPNGatewayConnectionDPDPrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPNGatewayConnectionDPDPrototype)
    end
  end
