...
# Unit tests for IbmCloudVpc::InstanceGroupManagerPolicyPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceGroupManagerPolicyPatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceGroupManagerPolicyPatch.new
  end
  ...
  describe 'test an instance of InstanceGroupManagerPolicyPatch' do
    it 'should create an instance of InstanceGroupManagerPolicyPatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceGroupManagerPolicyPatch)
    end
  end
