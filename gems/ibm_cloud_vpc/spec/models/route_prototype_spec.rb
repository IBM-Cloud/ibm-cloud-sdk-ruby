...
# Unit tests for IbmCloudVpc::RoutePrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RoutePrototype' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RoutePrototype.new
  end
  ...
  describe 'test an instance of RoutePrototype' do
    it 'should create an instance of RoutePrototype' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RoutePrototype)
    end
  end
  describe 'test attribute "action"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["delegate", "deliver", "drop"])
