...
# Unit tests for IbmCloudVpc::ReservedIPPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIPPatch' do
  before do
    # run before each test
    @instance = IbmCloudVpc::ReservedIPPatch.new
  end
  ...
  describe 'test an instance of ReservedIPPatch' do
    it 'should create an instance of ReservedIPPatch' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIPPatch)
    end
  end
