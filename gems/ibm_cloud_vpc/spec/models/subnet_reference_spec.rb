...
# Unit tests for IbmCloudVpc::SubnetReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SubnetReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::SubnetReference.new
  end
  ...
  describe 'test an instance of SubnetReference' do
    it 'should create an instance of SubnetReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::SubnetReference)
    end
  end
