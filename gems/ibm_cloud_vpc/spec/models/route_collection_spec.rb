...
# Unit tests for IbmCloudVpc::RouteCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RouteCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::RouteCollection.new
  end
  ...
  describe 'test an instance of RouteCollection' do
    it 'should create an instance of RouteCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::RouteCollection)
    end
  end
