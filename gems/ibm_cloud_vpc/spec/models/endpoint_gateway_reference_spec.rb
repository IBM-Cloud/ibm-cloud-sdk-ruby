...
# Unit tests for IbmCloudVpc::EndpointGatewayReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EndpointGatewayReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::EndpointGatewayReference.new
  end
  ...
  describe 'test an instance of EndpointGatewayReference' do
    it 'should create an instance of EndpointGatewayReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::EndpointGatewayReference)
    end
  end
