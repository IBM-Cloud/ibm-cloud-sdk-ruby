...
# Unit tests for IbmCloudVpc::NetworkInterfaceInstanceContextReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NetworkInterfaceInstanceContextReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::NetworkInterfaceInstanceContextReference.new
  end
  ...
  describe 'test an instance of NetworkInterfaceInstanceContextReference' do
    it 'should create an instance of NetworkInterfaceInstanceContextReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::NetworkInterfaceInstanceContextReference)
    end
  end
