...
# Unit tests for IbmCloudVpc::InstanceGPU
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceGPU' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceGPU.new
  end
  ...
  describe 'test an instance of InstanceGPU' do
    it 'should create an instance of InstanceGPU' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceGPU)
    end
  end
