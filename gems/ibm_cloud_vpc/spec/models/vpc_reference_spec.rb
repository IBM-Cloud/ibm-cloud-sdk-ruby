...
# Unit tests for IbmCloudVpc::VPCReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPCReference' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPCReference.new
  end
  ...
  describe 'test an instance of VPCReference' do
    it 'should create an instance of VPCReference' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPCReference)
    end
  end
