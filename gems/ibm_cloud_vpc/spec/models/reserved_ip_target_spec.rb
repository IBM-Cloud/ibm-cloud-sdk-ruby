...
# Unit tests for IbmCloudVpc::ReservedIPTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReservedIPTarget' do
  before do
  ...
  describe 'test an instance of ReservedIPTarget' do
    it 'should create an instance of ReservedIPTarget' do
      expect(@instance).to be_instance_of(IbmCloudVpc::ReservedIPTarget)
    end
  end
end
