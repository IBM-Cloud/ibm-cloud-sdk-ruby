...
# Unit tests for IbmCloudVpc::InstanceProfileVCPU
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InstanceProfileVCPU' do
  before do
    # run before each test
    @instance = IbmCloudVpc::InstanceProfileVCPU.new
  end
  ...
  describe 'test an instance of InstanceProfileVCPU' do
    it 'should create an instance of InstanceProfileVCPU' do
      expect(@instance).to be_instance_of(IbmCloudVpc::InstanceProfileVCPU)
    end
  end
