...
# Unit tests for IbmCloudVpc::VPNGatewayCollection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VPNGatewayCollection' do
  before do
    # run before each test
    @instance = IbmCloudVpc::VPNGatewayCollection.new
  end
  ...
  describe 'test an instance of VPNGatewayCollection' do
    it 'should create an instance of VPNGatewayCollection' do
      expect(@instance).to be_instance_of(IbmCloudVpc::VPNGatewayCollection)
    end
  end
  ...
  describe 'test attribute "vpn_gateways"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
