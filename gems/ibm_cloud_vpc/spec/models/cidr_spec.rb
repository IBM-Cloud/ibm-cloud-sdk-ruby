...
# Unit tests for IbmCloudVpc::CIDR
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CIDR' do
  before do
    # run before each test
    @instance = IbmCloudVpc::CIDR.new
  end
  ...
  describe 'test an instance of CIDR' do
    it 'should create an instance of CIDR' do
      expect(@instance).to be_instance_of(IbmCloudVpc::CIDR)
    end
  end
