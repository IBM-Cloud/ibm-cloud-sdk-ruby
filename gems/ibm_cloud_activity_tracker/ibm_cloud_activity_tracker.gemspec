require_relative 'lib/ibm_cloud_activity_tracker/version'

Gem::Specification.new do |spec|
  spec.name          = "ibm_cloud_activity_tracker"
  spec.version       = IbmCloudActivityTracker::VERSION
  spec.authors       = ["nasar.khan@ibm.com"]
  spec.email         = ["nasar.khan@ibm.com"]

  spec.summary       = %q{IBM Cloud Activity Tracker Ruby SDK}
