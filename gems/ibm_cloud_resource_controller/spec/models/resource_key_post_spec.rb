...
# Unit tests for IbmCloudResourceController::ResourceKeyPost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ResourceKeyPost' do
  before do
  ...
  describe 'test an instance of ResourceKeyPost' do
    it 'should create an instance of ResourceKeyPost' do
      expect(@instance).to be_instance_of(IbmCloudResourceController::ResourceKeyPost)
    end
  end
