...
# Unit tests for IbmCloudResourceController::ResourceBindingsList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ResourceBindingsList' do
  before do
    # run before each test
    @instance = IbmCloudResourceController::ResourceBindingsList.new
  end
  ...
  describe 'test an instance of ResourceBindingsList' do
    it 'should create an instance of ResourceBindingsList' do
      expect(@instance).to be_instance_of(IbmCloudResourceController::ResourceBindingsList)
    end
  end
