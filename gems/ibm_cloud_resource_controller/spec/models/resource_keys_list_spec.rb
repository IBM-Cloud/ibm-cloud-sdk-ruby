...
# Unit tests for IbmCloudResourceController::ResourceKeysList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ResourceKeysList' do
  before do
  ...
  describe 'test an instance of ResourceKeysList' do
    it 'should create an instance of ResourceKeysList' do
      expect(@instance).to be_instance_of(IbmCloudResourceController::ResourceKeysList)
    end
  end
