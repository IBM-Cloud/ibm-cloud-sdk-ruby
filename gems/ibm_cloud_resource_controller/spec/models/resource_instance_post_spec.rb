...
# Unit tests for IbmCloudResourceController::ResourceInstancePost
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ResourceInstancePost' do
  before do
  ...
  describe 'test an instance of ResourceInstancePost' do
    it 'should create an instance of ResourceInstancePost' do
      expect(@instance).to be_instance_of(IbmCloudResourceController::ResourceInstancePost)
    end
  end
