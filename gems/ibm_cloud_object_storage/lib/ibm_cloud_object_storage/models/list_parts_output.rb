...
module IbmCloudObjectStorage
  class ListPartsOutput
    ...
    attr_accessor :part_number_marker

    attr_accessor :next_part_number_marker
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudObjectStorage::ListPartsOutput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudObjectStorage::ListPartsOutput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'part_number_marker')
        self.part_number_marker = attributes[:'part_number_marker']
      end

      if attributes.key?(:'next_part_number_marker')
        self.next_part_number_marker = attributes[:'next_part_number_marker']
      end

      if attributes.key?(:'max_parts')
        self.max_parts = attributes[:'max_parts']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          part_number_marker == o.part_number_marker &&
          next_part_number_marker == o.next_part_number_marker &&
          max_parts == o.max_parts &&
    ...
    def hash
      [bucket, key, upload_id, part_number_marker, next_part_number_marker, max_parts, is_truncated, parts, initiator, owner, storage_class].hash
    end
