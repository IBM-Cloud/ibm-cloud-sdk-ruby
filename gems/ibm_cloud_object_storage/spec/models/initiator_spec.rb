...
# Unit tests for IbmCloudObjectStorage::Initiator
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Initiator' do
  before do
    # run before each test
    @instance = IbmCloudObjectStorage::Initiator.new
  end
  ...
  describe 'test an instance of Initiator' do
    it 'should create an instance of Initiator' do
      expect(@instance).to be_instance_of(IbmCloudObjectStorage::Initiator)
    end
  end
