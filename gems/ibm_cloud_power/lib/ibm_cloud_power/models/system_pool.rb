...
module IbmCloudPower
  ...
  class SystemPool < ApiModelBase
    attr_accessor :capacity

    # Core allocation increment
    attr_accessor :core_increment

    # Processor to Memory (GiB) Ratio
    attr_accessor :core_memory_ratio

    attr_accessor :max_available

    attr_accessor :max_cores_available

    attr_accessor :max_memory_available

    attr_accessor :shared_core_ratio
    ...
    def self.openapi_types
      {
        :'capacity' => :'SystemPoolCapacity',
        :'core_increment' => :'Float',
        :'core_memory_ratio' => :'Float',
        :'max_available' => :'SystemPoolCapacity',
        :'max_cores_available' => :'SystemPoolCapacity',
        :'max_memory_available' => :'SystemPoolCapacity',
        :'shared_core_ratio' => :'SystemPoolSharedCoreRatio',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::SystemPool` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::SystemPool`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'core_increment')
        self.core_increment = attributes[:'core_increment']
      end

      if attributes.key?(:'core_memory_ratio')
        self.core_memory_ratio = attributes[:'core_memory_ratio']
      end

      if attributes.key?(:'max_available')
        self.max_available = attributes[:'max_available']
      end

      if attributes.key?(:'max_cores_available')
        self.max_cores_available = attributes[:'max_cores_available']
      end

      if attributes.key?(:'max_memory_available')
        self.max_memory_available = attributes[:'max_memory_available']
      end

      if attributes.key?(:'shared_core_ratio')
        self.shared_core_ratio = attributes[:'shared_core_ratio']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          capacity == o.capacity &&
          core_increment == o.core_increment &&
          core_memory_ratio == o.core_memory_ratio &&
          max_available == o.max_available &&
          max_cores_available == o.max_cores_available &&
          max_memory_available == o.max_memory_available &&
          shared_core_ratio == o.shared_core_ratio &&
          systems == o.systems &&
          type == o.type
    end
    ...
    def hash
      [capacity, core_increment, core_memory_ratio, max_available, max_cores_available, max_memory_available, shared_core_ratio, systems, type].hash
    end
