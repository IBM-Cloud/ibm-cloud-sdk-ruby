...
module IbmCloudPower
  class VPNConnectionCreateResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::VPNConnectionCreateResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'local_gateway_address')
        ...
        self.local_gateway_address = nil
      end
    ...
    # @param [Object] dead_peer_detection Value to be assigned
    def dead_peer_detection=(dead_peer_detection)
      if dead_peer_detection.nil?
        fail ArgumentError, 'dead_peer_detection cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] local_gateway_address Value to be assigned
    def local_gateway_address=(local_gateway_address)
      if local_gateway_address.nil?
        fail ArgumentError, 'local_gateway_address cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] vpn_gateway_address Value to be assigned
    def vpn_gateway_address=(vpn_gateway_address)
      if vpn_gateway_address.nil?
        fail ArgumentError, 'vpn_gateway_address cannot be nil'
      end
    ...
    def hash
      [dead_peer_detection, id, ike_policy, ip_sec_policy, local_gateway_address, mode, name, network_ids, peer_gateway_address, peer_subnets, status, vpn_gateway_address, job_ref].hash
    end
