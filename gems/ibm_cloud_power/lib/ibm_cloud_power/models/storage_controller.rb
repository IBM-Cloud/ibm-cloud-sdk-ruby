...
module IbmCloudPower
  ...
  class StorageController < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'pool_total_storage' => :'poolTotalStorage',
        :'pools' => :'pools'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'health' => :'String',
        :'pool_storage' => :'Float',
        :'pool_total_storage' => :'Float',
        :'pools' => :'Hash<String, StoragePoolCombined>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::StorageController` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::StorageController`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pool_storage')
        self.pool_storage = attributes[:'pool_storage']
      else
        self.pool_storage = nil
      end

      if attributes.key?(:'pool_total_storage')
        self.pool_total_storage = attributes[:'pool_total_storage']
      else
        self.pool_total_storage = nil
      end

      if attributes.key?(:'pools')
        if (value = attributes[:'pools']).is_a?(Hash)
          self.pools = value
        end
      else
        self.pools = nil
    ...
    def list_invalid_properties
      ...
      if @pool_storage.nil?
        invalid_properties.push('invalid value for "pool_storage", pool_storage cannot be nil.')
      end

      if @pool_total_storage.nil?
        invalid_properties.push('invalid value for "pool_total_storage", pool_total_storage cannot be nil.')
      end

      if @pools.nil?
        invalid_properties.push('invalid value for "pools", pools cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pool_storage.nil?
      return false if @pool_total_storage.nil?
      return false if @pools.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pool_storage Value to be assigned
    def pool_storage=(pool_storage)
      if pool_storage.nil?
        fail ArgumentError, 'pool_storage cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pool_total_storage Value to be assigned
    def pool_total_storage=(pool_total_storage)
      if pool_total_storage.nil?
        fail ArgumentError, 'pool_total_storage cannot be nil'
      end

      @pool_total_storage = pool_total_storage
    end

    # Custom attribute writer method with validation
    # @param [Object] pools Value to be assigned
    def pools=(pools)
      if pools.nil?
        fail ArgumentError, 'pools cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          health == o.health &&
          pool_storage == o.pool_storage &&
          pool_total_storage == o.pool_total_storage &&
          pools == o.pools
    end
    ...
    def hash
      [display_name, health, pool_storage, pool_total_storage, pools].hash
    end
