  ...
  class CloudConnectionGRETunnel
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::CloudConnectionGRETunnel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::CloudConnectionGRETunnel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] dest_ip_address Value to be assigned
    def dest_ip_address=(dest_ip_address)
      if dest_ip_address.nil?
        fail ArgumentError, 'dest_ip_address cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] source_ip_address Value to be assigned
    def source_ip_address=(source_ip_address)
      if source_ip_address.nil?
        fail ArgumentError, 'source_ip_address cannot be nil'
      end
