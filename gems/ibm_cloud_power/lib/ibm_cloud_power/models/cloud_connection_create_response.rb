...
module IbmCloudPower
  class CloudConnectionCreateResponse
    ...
    def hash
      [job_ref, classic, cloud_connection_id, connection_mode, creation_date, global_routing, ibm_ip_address, link_status, metered, name, networks, port, speed, user_ip_address, vpc].hash
    end
