...
module IbmCloudPower
  class SPPPlacementGroup < ApiModelBase
    ...
    attr_accessor :member_shared_processor_pools
    ...
    def self.openapi_types
      {
        :'crn' => :'String',
        :'id' => :'String',
        :'member_shared_processor_pools' => :'Array<String>',
        :'name' => :'String',
        :'policy' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::SPPPlacementGroup` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::SPPPlacementGroup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'member_shared_processor_pools')
        if (value = attributes[:'member_shared_processor_pools']).is_a?(Array)
          self.member_shared_processor_pools = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          crn == o.crn &&
          id == o.id &&
          member_shared_processor_pools == o.member_shared_processor_pools &&
          name == o.name &&
          policy == o.policy &&
    ...
    def hash
      [crn, id, member_shared_processor_pools, name, policy, user_tags].hash
    end
