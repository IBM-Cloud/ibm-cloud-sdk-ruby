...
module IbmCloudPower
  class CloudInstance < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::CloudInstance`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] initialized Value to be assigned
    def initialized=(initialized)
      if initialized.nil?
        fail ArgumentError, 'initialized cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] openstack_id Value to be assigned
    def openstack_id=(openstack_id)
      if openstack_id.nil?
        fail ArgumentError, 'openstack_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pvm_instances Value to be assigned
    def pvm_instances=(pvm_instances)
      if pvm_instances.nil?
        fail ArgumentError, 'pvm_instances cannot be nil'
      end

      @pvm_instances = pvm_instances
    end
