...
module IbmCloudPower
  class VolumesCloneAsyncRequest < ApiModelBase
    ...
    attr_accessor :target_replication_enabled
    ...
    attr_accessor :target_storage_tier
    ...
    def self.attribute_map
      {
        :'name' => :'name',
        :'target_replication_enabled' => :'targetReplicationEnabled',
        :'target_storage_tier' => :'targetStorageTier',
        :'user_tags' => :'userTags',
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'target_replication_enabled' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::VolumesCloneAsyncRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::VolumesCloneAsyncRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'target_replication_enabled')
        self.target_replication_enabled = attributes[:'target_replication_enabled']
      end

      if attributes.key?(:'target_storage_tier')
        self.target_storage_tier = attributes[:'target_storage_tier']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          target_replication_enabled == o.target_replication_enabled &&
          target_storage_tier == o.target_storage_tier &&
    ...
    def hash
      [name, target_replication_enabled, target_storage_tier, user_tags, volume_ids].hash
    end
