...
module IbmCloudPower
  class CloudConnectionVirtualPrivateClouds
    ...
    def self.openapi_types
      {
        :'virtual_private_clouds' => :'Array<CloudConnectionVirtualPrivateCloudsVirtualPrivateCloudsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::CloudConnectionVirtualPrivateClouds`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'virtual_private_clouds')
        ...
        self.virtual_private_clouds = nil
      end
    end
    ...
    # @param [Object] virtual_private_clouds Value to be assigned
    def virtual_private_clouds=(virtual_private_clouds)
      if virtual_private_clouds.nil?
        fail ArgumentError, 'virtual_private_clouds cannot be nil'
      end

      @virtual_private_clouds = virtual_private_clouds
    end
