  ...
  class Datacenter < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'capabilities_details' => :'capabilitiesDetails',
        :'href' => :'href',
        :'location' => :'location',
        :'status' => :'status',
        :'type' => :'type'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::Datacenter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::Datacenter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'capabilities_details')
        self.capabilities_details = attributes[:'capabilities_details']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["active", "maintenance", "down"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["active", "maintenance", "down"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          capabilities_details == o.capabilities_details &&
          href == o.href &&
          location == o.location &&
          status == o.status &&
          type == o.type
    ...
    def hash
      [capabilities, capabilities_details, href, location, status, type].hash
    end
