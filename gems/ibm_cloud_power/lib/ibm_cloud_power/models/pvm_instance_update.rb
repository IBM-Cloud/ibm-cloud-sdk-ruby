...
module IbmCloudPower
  class PVMInstanceUpdate < ApiModelBase
    ...
    def hash
      [allow_remote_restart, default_trusted_profile, license_repository_capacity, memory, metadata_service, migratable, pin_policy, preferred_processor_compatibility_mode, proc_type, processors, sap_profile_id, server_name, software_licenses, storage_pool_affinity, virtual_cores].hash
    end
