...
module IbmCloudPower
  class ClonedVolumeDetail
    ...
    def self.openapi_types
      {
        :'clone' => :'ClonedVolumeDetailClone',
        :'source' => :'ClonedVolumeDetailClone'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::ClonedVolumeDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] clone Value to be assigned
    def clone=(clone)
      if clone.nil?
        fail ArgumentError, 'clone cannot be nil'
      end
