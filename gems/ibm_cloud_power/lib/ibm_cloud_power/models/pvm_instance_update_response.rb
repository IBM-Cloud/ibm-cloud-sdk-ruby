...
module IbmCloudPower
  class PVMInstanceUpdateResponse
    ...
    def hash
      [license_repository_capacity, memory, pin_policy, proc_type, processors, server_name, status_url, storage_pool_affinity, virtual_cores].hash
    end
