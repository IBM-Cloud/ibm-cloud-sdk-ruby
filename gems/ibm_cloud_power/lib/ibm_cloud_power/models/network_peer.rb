...
module IbmCloudPower
  class NetworkPeer < ApiModelBase
    ...
    def self.attribute_map
      {
        ...
        :'error' => :'error',
        :'export_route_filters' => :'exportRouteFilters',
        :'ibm_asn' => :'ibmASN',
        :'ibm_cidr' => :'ibmCidr',
        :'id' => :'id',
        :'import_route_filters' => :'importRouteFilters',
        :'name' => :'name',
    ...
    def self.openapi_types
      {
        ...
        :'error' => :'String',
        :'export_route_filters' => :'Array<RouteFilter>',
        :'ibm_asn' => :'Integer',
        :'ibm_cidr' => :'String',
        :'id' => :'String',
        :'import_route_filters' => :'Array<RouteFilter>',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::NetworkPeer` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::NetworkPeer`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'export_route_filters')
        if (value = attributes[:'export_route_filters']).is_a?(Array)
          self.export_route_filters = value
        end
      else
        self.export_route_filters = nil
      end
      ...
      if attributes.key?(:'import_route_filters')
        if (value = attributes[:'import_route_filters']).is_a?(Array)
          self.import_route_filters = value
        end
      else
        self.import_route_filters = nil
      end
    ...
    def list_invalid_properties
      ...
      if @customer_asn.nil?
        invalid_properties.push('invalid value for "customer_asn", customer_asn cannot be nil.')
      end

      if @customer_cidr.nil?
        invalid_properties.push('invalid value for "customer_cidr", customer_cidr cannot be nil.')
      end

      if @default_export_route_filter.nil?
        invalid_properties.push('invalid value for "default_export_route_filter", default_export_route_filter cannot be nil.')
      end

      if @default_import_route_filter.nil?
        invalid_properties.push('invalid value for "default_import_route_filter", default_import_route_filter cannot be nil.')
      end
      ...
      if @export_route_filters.nil?
        invalid_properties.push('invalid value for "export_route_filters", export_route_filters cannot be nil.')
      end

      if @ibm_asn.nil?
        invalid_properties.push('invalid value for "ibm_asn", ibm_asn cannot be nil.')
      end

      if @ibm_cidr.nil?
        invalid_properties.push('invalid value for "ibm_cidr", ibm_cidr cannot be nil.')
      end
      ...
      if @import_route_filters.nil?
        invalid_properties.push('invalid value for "import_route_filters", import_route_filters cannot be nil.')
      end
      ...
      if @peer_interface_id.nil?
        invalid_properties.push('invalid value for "peer_interface_id", peer_interface_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @customer_asn.nil?
      return false if @customer_cidr.nil?
      return false if @default_export_route_filter.nil?
      ...
      return false if @default_import_route_filter.nil?
      ...
      return false if @export_route_filters.nil?
      return false if @ibm_asn.nil?
      return false if @ibm_cidr.nil?
      return false if @id.nil?
      return false if @import_route_filters.nil?
      return false if @name.nil?
      return false if @peer_interface_id.nil?
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ["active", "configuring", "removing", "error", "updating"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] customer_asn Value to be assigned
    def customer_asn=(customer_asn)
      if customer_asn.nil?
        fail ArgumentError, 'customer_asn cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] customer_cidr Value to be assigned
    def customer_cidr=(customer_cidr)
      if customer_cidr.nil?
        fail ArgumentError, 'customer_cidr cannot be nil'
      end
    ...
    # @param [Object] default_export_route_filter Object to be assigned
    def default_export_route_filter=(default_export_route_filter)
      validator = EnumAttributeValidator.new('String', ["allow", "deny"])
      unless validator.valid?(default_export_route_filter)
        fail ArgumentError, "invalid value for \"default_export_route_filter\", must be one of #{validator.allowable_values}."
      end
      @default_export_route_filter = default_export_route_filter
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] default_import_route_filter Object to be assigned
    def default_import_route_filter=(default_import_route_filter)
      validator = EnumAttributeValidator.new('String', ["allow", "deny"])
      unless validator.valid?(default_import_route_filter)
        fail ArgumentError, "invalid value for \"default_import_route_filter\", must be one of #{validator.allowable_values}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] export_route_filters Value to be assigned
    def export_route_filters=(export_route_filters)
      if export_route_filters.nil?
        fail ArgumentError, 'export_route_filters cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ibm_asn Value to be assigned
    def ibm_asn=(ibm_asn)
      if ibm_asn.nil?
        fail ArgumentError, 'ibm_asn cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ibm_cidr Value to be assigned
    def ibm_cidr=(ibm_cidr)
      if ibm_cidr.nil?
        fail ArgumentError, 'ibm_cidr cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] import_route_filters Value to be assigned
    def import_route_filters=(import_route_filters)
      if import_route_filters.nil?
        fail ArgumentError, 'import_route_filters cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] peer_interface_id Value to be assigned
    def peer_interface_id=(peer_interface_id)
      if peer_interface_id.nil?
        fail ArgumentError, 'peer_interface_id cannot be nil'
      end
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["active", "configuring", "removing", "error", "updating"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["dcnetwork_bgp"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] vlan Value to be assigned
    def vlan=(vlan)
      if vlan.nil?
        fail ArgumentError, 'vlan cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error == o.error &&
          export_route_filters == o.export_route_filters &&
          ibm_asn == o.ibm_asn &&
          ibm_cidr == o.ibm_cidr &&
          id == o.id &&
          import_route_filters == o.import_route_filters &&
          name == o.name &&
    ...
    def hash
      [creation_date, customer_asn, customer_cidr, default_export_route_filter, default_import_route_filter, error, export_route_filters, ibm_asn, ibm_cidr, id, import_route_filters, name, peer_interface_id, state, type, updated_date, vlan].hash
    end
