...
module IbmCloudPower
  class SAPProfile < ApiModelBase
    ...
    attr_accessor :full_system_profile
    ...
    attr_accessor :supported_systems

    # Type of profile
    attr_accessor :type

    attr_accessor :vpmem_volume

    # List of supported workload types
    attr_accessor :workload_types
    ...
    def self.attribute_map
      {
        ...
        :'full_system_profile' => :'fullSystemProfile',
        :'memory' => :'memory',
    ...
    def self.openapi_types
      {
        ...
        :'deprecated' => :'Boolean',
        :'full_system_profile' => :'Boolean',
        :'memory' => :'Integer',
        :'profile_id' => :'String',
        :'saps' => :'Integer',
        :'smt_mode' => :'Integer',
        :'supported_systems' => :'Array<String>',
        :'type' => :'String',
        :'vpmem_volume' => :'SAPProfileVpmemVolume',
        :'workload_types' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::SAPProfile` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::SAPProfile`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'asaps')
        self.asaps = attributes[:'asaps']
      end

      if attributes.key?(:'certified')
        self.certified = attributes[:'certified']
      else
        self.certified = nil
      end
      ...
      if attributes.key?(:'default_system')
        self.default_system = attributes[:'default_system']
      end
      ...
      if attributes.key?(:'full_system_profile')
        self.full_system_profile = attributes[:'full_system_profile']
      end
      ...
      if attributes.key?(:'saps')
        self.saps = attributes[:'saps']
      end
      ...
      if attributes.key?(:'supported_systems')
        if (value = attributes[:'supported_systems']).is_a?(Array)
          self.supported_systems = value
        end
      end
      ...
      if attributes.key?(:'vpmem_volume')
        self.vpmem_volume = attributes[:'vpmem_volume']
      end

      if attributes.key?(:'workload_types')
        if (value = attributes[:'workload_types']).is_a?(Array)
          self.workload_types = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @certified.nil?
        invalid_properties.push('invalid value for "certified", certified cannot be nil.')
      end
    ...
    def valid?
      ...
      smt_mode_validator = EnumAttributeValidator.new('Integer', [4, 8])
      return false unless smt_mode_validator.valid?(@smt_mode)
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["balanced", "compute", "memory", "non-production", "ultra-memory", "small", "sap-rise", "sap-rise-app"])
      return false unless type_validator.valid?(@type)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] certified Value to be assigned
    def certified=(certified)
      if certified.nil?
        fail ArgumentError, 'certified cannot be nil'
      end
    ...
    def smt_mode=(smt_mode)
      validator = EnumAttributeValidator.new('Integer', [4, 8])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["balanced", "compute", "memory", "non-production", "ultra-memory", "small", "sap-rise", "sap-rise-app"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cores == o.cores &&
          default_system == o.default_system &&
          deprecated == o.deprecated &&
          full_system_profile == o.full_system_profile &&
          memory == o.memory &&
          profile_id == o.profile_id &&
          saps == o.saps &&
          smt_mode == o.smt_mode &&
          supported_systems == o.supported_systems &&
          type == o.type &&
          vpmem_volume == o.vpmem_volume &&
          workload_types == o.workload_types
    end
    ...
    def hash
      [asaps, certified, cores, default_system, deprecated, full_system_profile, memory, profile_id, saps, smt_mode, supported_systems, type, vpmem_volume, workload_types].hash
    end
