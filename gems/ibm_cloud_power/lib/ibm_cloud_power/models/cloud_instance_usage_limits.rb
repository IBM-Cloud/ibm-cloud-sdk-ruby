...
module IbmCloudPower
  class CloudInstanceUsageLimits
    ...
    def hash
      [instances, memory, proc_units, processors, storage, instance_memory, instance_proc_units, peering_networks, peering_bandwidth, storage_ssd, storage_standard].hash
    end
