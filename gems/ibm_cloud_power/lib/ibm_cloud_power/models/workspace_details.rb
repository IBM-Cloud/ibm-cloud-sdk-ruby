...
module IbmCloudPower
  class WorkspaceDetails < ApiModelBase
    ...
    attr_accessor :power_edge_router
    ...
    def self.attribute_map
      {
        ...
        :'power_edge_router' => :'powerEdgeRouter'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'crn' => :'String',
        :'href' => :'String',
        :'network_security_groups' => :'WorkspaceNetworkSecurityGroupsDetails',
        :'power_edge_router' => :'WorkspacePowerEdgeRouterDetails'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::WorkspaceDetails` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::WorkspaceDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'network_security_groups')
        self.network_security_groups = attributes[:'network_security_groups']
      end

      if attributes.key?(:'power_edge_router')
        self.power_edge_router = attributes[:'power_edge_router']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          crn == o.crn &&
          href == o.href &&
          network_security_groups == o.network_security_groups &&
          power_edge_router == o.power_edge_router
    end
    ...
    def hash
      [creation_date, crn, href, network_security_groups, power_edge_router].hash
    end
