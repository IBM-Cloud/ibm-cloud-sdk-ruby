...
module IbmCloudPower
  class SharedProcessorPoolCreate < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::SharedProcessorPoolCreate` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::SharedProcessorPoolCreate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'placement_group_id')
        self.placement_group_id = attributes[:'placement_group_id']
      end
    ...
    def list_invalid_properties
      ...
      if @host_group.nil?
        invalid_properties.push('invalid value for "host_group", host_group cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @host_group.nil?
    ...
    # @param [Object] host_group Value to be assigned
    def host_group=(host_group)
      if host_group.nil?
        fail ArgumentError, 'host_group cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          host_id == o.host_id &&
          name == o.name &&
          placement_group_id == o.placement_group_id &&
    ...
    def hash
      [host_group, host_id, name, placement_group_id, reserved_cores, user_tags].hash
    end
