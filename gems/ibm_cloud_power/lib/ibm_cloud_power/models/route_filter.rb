...
module IbmCloudPower
  class RouteFilter < ApiModelBase
    ...
    # action of the filter * allow: allow * deny: deny 
    attr_accessor :action

    # time stamp for create route filter
    attr_accessor :creation_date

    # direction of the filter * import - import the routes * export - export the routes 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::RouteFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::RouteFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'route_filter_id')
        self.route_filter_id = attributes[:'route_filter_id']
      else
        self.route_filter_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if !@ge.nil? && @ge > 32
        invalid_properties.push('invalid value for "ge", must be smaller than or equal to 32.')
      end
      ...
      if !@le.nil? && @le > 32
        invalid_properties.push('invalid value for "le", must be smaller than or equal to 32.')
      end
      ...
      if @route_filter_id.nil?
        invalid_properties.push('invalid value for "route_filter_id", route_filter_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@ge.nil? && @ge > 32
      return false if !@ge.nil? && @ge < 1
      return false if !@le.nil? && @le > 32
      ...
      direction_validator = EnumAttributeValidator.new('String', ["import", "export"])
      return false unless direction_validator.valid?(@direction)
      return false if @error.nil?
      return false if @index.nil?
      return false if @prefix.nil?
      return false if @route_filter_id.nil?
    ...
    def ge=(ge)
      if !ge.nil? && ge > 32
        fail ArgumentError, 'invalid value for "ge", must be smaller than or equal to 32.'
      end
    ...
    def le=(le)
      if !le.nil? && le > 32
        fail ArgumentError, 'invalid value for "le", must be smaller than or equal to 32.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] route_filter_id Value to be assigned
    def route_filter_id=(route_filter_id)
      if route_filter_id.nil?
        fail ArgumentError, 'route_filter_id cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          index == o.index &&
          prefix == o.prefix &&
          route_filter_id == o.route_filter_id &&
          state == o.state
    end
    ...
    def hash
      [ge, le, action, creation_date, direction, error, index, prefix, route_filter_id, state].hash
    end
