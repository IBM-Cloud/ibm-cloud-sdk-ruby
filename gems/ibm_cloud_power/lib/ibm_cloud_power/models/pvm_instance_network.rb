...
module IbmCloudPower
  ...
  class PVMInstanceNetwork < ApiModelBase
    ...
    attr_accessor :network_security_groups_href
    ...
    def self.attribute_map
      {
        ...
        :'network_security_groups_href' => :'networkSecurityGroupsHref',
        :'type' => :'type',
        :'version' => :'version'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'network_security_groups_href' => :'Array<String>',
        :'type' => :'String',
        :'version' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::PVMInstanceNetwork`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'network_interface_id')
        self.network_interface_id = attributes[:'network_interface_id']
      end
      ...
      if attributes.key?(:'network_security_group_ids')
        if (value = attributes[:'network_security_group_ids']).is_a?(Array)
          self.network_security_group_ids = value
        end
      end

      if attributes.key?(:'network_security_groups_href')
        if (value = attributes[:'network_security_groups_href']).is_a?(Array)
          self.network_security_groups_href = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          network_interface_id == o.network_interface_id &&
          network_name == o.network_name &&
          network_security_group_ids == o.network_security_group_ids &&
          network_security_groups_href == o.network_security_groups_href &&
          type == o.type &&
          version == o.version
    end
    ...
    def hash
      [external_ip, href, ip, ip_address, mac_address, network_id, network_interface_id, network_name, network_security_group_ids, network_security_groups_href, type, version].hash
    end
