...
module IbmCloudPower
  class Network < ApiModelBase
    ...
    def hash
      [access_config, advertise, arp_broadcast, cidr, cloud_connections, crn, dhcp_managed, dns_servers, gateway, ip_address_metrics, ip_address_ranges, jumbo, mtu, name, network_id, public_ip_address_ranges, type, user_tags, vlan_id].hash
    end
