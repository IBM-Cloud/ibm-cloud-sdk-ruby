  ...
  class DatacenterLocation < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::DatacenterLocation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::DatacenterLocation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'region_display_name')
        self.region_display_name = attributes[:'region_display_name']
      else
        self.region_display_name = nil
      end
    ...
    def list_invalid_properties
      ...
      if @region_display_name.nil?
        invalid_properties.push('invalid value for "region_display_name", region_display_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @region_display_name.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] region_display_name Value to be assigned
    def region_display_name=(region_display_name)
      if region_display_name.nil?
        fail ArgumentError, 'region_display_name cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          region == o.region &&
          region_display_name == o.region_display_name &&
          type == o.type &&
          url == o.url
    end
    ...
    def hash
      [region, region_display_name, type, url].hash
    end
