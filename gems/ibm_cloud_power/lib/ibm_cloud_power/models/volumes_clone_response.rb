...
module IbmCloudPower
  class VolumesCloneResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::VolumesCloneResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cloned_volumes')
        self.cloned_volumes = attributes[:'cloned_volumes']
      end
    end
    ...
    def hash
      [additional_properties, cloned_volumes].hash
    end
