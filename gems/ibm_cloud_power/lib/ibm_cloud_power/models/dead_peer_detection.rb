...
module IbmCloudPower
  ...
  class DeadPeerDetection < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::DeadPeerDetection` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::DeadPeerDetection`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @interval > 60
        invalid_properties.push('invalid value for "interval", must be smaller than or equal to 60.')
      end

      if @interval < 2
        invalid_properties.push('invalid value for "interval", must be greater than or equal to 2.')
      end
      ...
      if @threshold > 5
        invalid_properties.push('invalid value for "threshold", must be smaller than or equal to 5.')
      end

      if @threshold < 1
        invalid_properties.push('invalid value for "threshold", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ["restart"])
      return false unless action_validator.valid?(@action)
      return false if @interval.nil?
      return false if @interval > 60
      return false if @interval < 2
      return false if @threshold.nil?
      return false if @threshold > 5
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ["restart"])
    ...
    def interval=(interval)
      ...
      if interval > 60
        fail ArgumentError, 'invalid value for "interval", must be smaller than or equal to 60.'
      end

      if interval < 2
        fail ArgumentError, 'invalid value for "interval", must be greater than or equal to 2.'
      end
    ...
    def threshold=(threshold)
      ...
      if threshold > 5
        fail ArgumentError, 'invalid value for "threshold", must be smaller than or equal to 5.'
      end

      if threshold < 1
        fail ArgumentError, 'invalid value for "threshold", must be greater than or equal to 1.'
      end
    ...
    def hash
      [action, interval, threshold].hash
    end
