...
module IbmCloudPower
  ...
  class PodData < ApiModelBase
    ...
    # Total amount of physical storage in the Pod (GiB)
    attr_accessor :total_phys_storage

    # Total amount of usable storage in the Pod (GiB)
