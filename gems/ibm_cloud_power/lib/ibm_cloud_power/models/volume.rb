...
module IbmCloudPower
  class Volume
    ...
    def hash
      [volume_id, name, state, size, shareable, bootable, boot_volume, delete_on_termination, disk_type, volume_pool, volume_type, wwn, creation_date, last_update_date, pvm_instance_ids].hash
    end
