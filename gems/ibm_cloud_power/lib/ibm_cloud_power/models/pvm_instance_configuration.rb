...
module IbmCloudPower
  class PVMInstanceConfiguration
    ...
    attr_accessor :system_reference_codes
    ...
    def self.attribute_map
      {
        ...
        :'system_reference_codes' => :'systemReferenceCodes'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'software_licenses' => :'SoftwareLicenses',
        :'system_reference_codes' => :'Array<Array<SRC>>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::PVMInstanceConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::PVMInstanceConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'system_reference_codes')
        if (value = attributes[:'system_reference_codes']).is_a?(Array)
          self.system_reference_codes = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          system_reference_codes == o.system_reference_codes
    end
    ...
    def hash
      [console_language, license_repository_capacity, sap_profile, software_licenses, system_reference_codes].hash
    end
