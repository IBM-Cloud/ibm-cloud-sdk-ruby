...
module IbmCloudPower
  class VolumeGroupDetails < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'String',
        :'name' => :'String',
        :'replication_sites' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IbmCloudPower::VolumeGroupDetails` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IbmCloudPower::VolumeGroupDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'replication_sites')
        if (value = attributes[:'replication_sites']).is_a?(Array)
          self.replication_sites = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          name == o.name &&
          replication_sites == o.replication_sites &&
    ...
    def hash
      [auxiliary, consistency_group_name, id, name, replication_sites, replication_status, status, status_description, storage_pool, volume_ids].hash
    end
