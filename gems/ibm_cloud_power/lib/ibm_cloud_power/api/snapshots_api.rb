...
module IbmCloudPower
  class SnapshotsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [SnapshotV1]
    def v1_volume_snapshots_get_0(volume_snapshot_uuid, opts = {})
      data, _status_code, _headers = v1_volume_snapshots_get_0_with_http_info(volume_snapshot_uuid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SnapshotV1, Integer, Hash)>] SnapshotV1 data, response status code and response headers
    def v1_volume_snapshots_get_0_with_http_info(volume_snapshot_uuid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SnapshotsApi.v1_volume_snapshots_get_0 ...'
      end
      ...
      if @api_client.config.client_side_validation && volume_snapshot_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'volume_snapshot_uuid' when calling SnapshotsApi.v1_volume_snapshots_get_0"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SnapshotsApi.v1_volume_snapshots_get_0",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SnapshotsApi#v1_volume_snapshots_get_0\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
