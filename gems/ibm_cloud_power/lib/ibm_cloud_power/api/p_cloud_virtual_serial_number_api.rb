...
module IbmCloudPower
  class PCloudVirtualSerialNumberApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<SupportedSoftwareTier>]
    def pcloud_virtualserialnumber_softwaretiers_getall(opts = {})
      data, _status_code, _headers = pcloud_virtualserialnumber_softwaretiers_getall_with_http_info(opts)
      data
    end

    # List supported software tiers (IBMi licensing)
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<SupportedSoftwareTier>, Integer, Hash)>] Array<SupportedSoftwareTier> data, response status code and response headers
    def pcloud_virtualserialnumber_softwaretiers_getall_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PCloudVirtualSerialNumberApi.pcloud_virtualserialnumber_softwaretiers_getall ...'
      end
      # resource path
      local_var_path = '/v1/virtual-serial-number/software-tiers'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<SupportedSoftwareTier>'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"PCloudVirtualSerialNumberApi.pcloud_virtualserialnumber_softwaretiers_getall",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PCloudVirtualSerialNumberApi#pcloud_virtualserialnumber_softwaretiers_getall\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
