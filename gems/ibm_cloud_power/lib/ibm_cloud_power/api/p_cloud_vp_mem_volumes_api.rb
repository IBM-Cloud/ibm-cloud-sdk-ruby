...
module IbmCloudPower
  class PCloudVPMemVolumesApi
    ...
    # @param vpmem_volume_id [String] vPMEM Volume ID
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def pcloud_pvminstances_vpmem_volumes_delete(cloud_instance_id, pvm_instance_id, vpmem_volume_id, opts = {})
      data, _status_code, _headers = pcloud_pvminstances_vpmem_volumes_delete_with_http_info(cloud_instance_id, pvm_instance_id, vpmem_volume_id, opts)
      data
    end
    ...
    def pcloud_pvminstances_vpmem_volumes_delete_with_http_info(cloud_instance_id, pvm_instance_id, vpmem_volume_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_delete ...'
      end
      # verify the required parameter 'cloud_instance_id' is set
      if @api_client.config.client_side_validation && cloud_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'cloud_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_delete"
      end
      # verify the required parameter 'pvm_instance_id' is set
      if @api_client.config.client_side_validation && pvm_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'pvm_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_delete"
      end
      # verify the required parameter 'vpmem_volume_id' is set
      if @api_client.config.client_side_validation && vpmem_volume_id.nil?
        fail ArgumentError, "Missing the required parameter 'vpmem_volume_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_delete"
      end
      # resource path
      local_var_path = '/pcloud/v1/cloud-instances/{cloud_instance_id}/pvm-instances/{pvm_instance_id}/vpmem-volumes/{vpmem_volume_id}'.sub('{cloud_instance_id}', CGI.escape(cloud_instance_id.to_s)).sub('{pvm_instance_id}', CGI.escape(pvm_instance_id.to_s)).sub('{vpmem_volume_id}', CGI.escape(vpmem_volume_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_delete",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PCloudVPMemVolumesApi#pcloud_pvminstances_vpmem_volumes_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param vpmem_volume_id [String] vPMEM Volume ID
    # @param [Hash] opts the optional parameters
    # @return [VPMemVolumeReference]
    def pcloud_pvminstances_vpmem_volumes_get(cloud_instance_id, pvm_instance_id, vpmem_volume_id, opts = {})
      data, _status_code, _headers = pcloud_pvminstances_vpmem_volumes_get_with_http_info(cloud_instance_id, pvm_instance_id, vpmem_volume_id, opts)
      data
    end
    ...
    # @param vpmem_volume_id [String] vPMEM Volume ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(VPMemVolumeReference, Integer, Hash)>] VPMemVolumeReference data, response status code and response headers
    def pcloud_pvminstances_vpmem_volumes_get_with_http_info(cloud_instance_id, pvm_instance_id, vpmem_volume_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_get ...'
      end
      # verify the required parameter 'cloud_instance_id' is set
      if @api_client.config.client_side_validation && cloud_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'cloud_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_get"
      end
      # verify the required parameter 'pvm_instance_id' is set
      if @api_client.config.client_side_validation && pvm_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'pvm_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_get"
      end
      # verify the required parameter 'vpmem_volume_id' is set
      if @api_client.config.client_side_validation && vpmem_volume_id.nil?
        fail ArgumentError, "Missing the required parameter 'vpmem_volume_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_get"
      end
      # resource path
      local_var_path = '/pcloud/v1/cloud-instances/{cloud_instance_id}/pvm-instances/{pvm_instance_id}/vpmem-volumes/{vpmem_volume_id}'.sub('{cloud_instance_id}', CGI.escape(cloud_instance_id.to_s)).sub('{pvm_instance_id}', CGI.escape(pvm_instance_id.to_s)).sub('{vpmem_volume_id}', CGI.escape(vpmem_volume_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VPMemVolumeReference'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PCloudVPMemVolumesApi#pcloud_pvminstances_vpmem_volumes_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [VPMemVolumes]
    def pcloud_pvminstances_vpmem_volumes_getall(cloud_instance_id, pvm_instance_id, opts = {})
      data, _status_code, _headers = pcloud_pvminstances_vpmem_volumes_getall_with_http_info(cloud_instance_id, pvm_instance_id, opts)
      data
    end
    ...
    # @param pvm_instance_id [String] PCloud PVM Instance ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(VPMemVolumes, Integer, Hash)>] VPMemVolumes data, response status code and response headers
    def pcloud_pvminstances_vpmem_volumes_getall_with_http_info(cloud_instance_id, pvm_instance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_getall ...'
      end
      # verify the required parameter 'cloud_instance_id' is set
      if @api_client.config.client_side_validation && cloud_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'cloud_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_getall"
      end
      # verify the required parameter 'pvm_instance_id' is set
      if @api_client.config.client_side_validation && pvm_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'pvm_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_getall"
      end
      # resource path
      local_var_path = '/pcloud/v1/cloud-instances/{cloud_instance_id}/pvm-instances/{pvm_instance_id}/vpmem-volumes'.sub('{cloud_instance_id}', CGI.escape(cloud_instance_id.to_s)).sub('{pvm_instance_id}', CGI.escape(pvm_instance_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VPMemVolumes'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_getall",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PCloudVPMemVolumesApi#pcloud_pvminstances_vpmem_volumes_getall\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param cloud_instance_id [String] Cloud Instance ID of a PCloud Instance
    # @param pvm_instance_id [String] PCloud PVM Instance ID
    # @param body [VPMemVolumeAttach] PVM Instance vPMEM volume create parameters
    # @param [Hash] opts the optional parameters
    # @return [VPMemVolumes]
    def pcloud_pvminstances_vpmem_volumes_post(cloud_instance_id, pvm_instance_id, body, opts = {})
      data, _status_code, _headers = pcloud_pvminstances_vpmem_volumes_post_with_http_info(cloud_instance_id, pvm_instance_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(VPMemVolumes, Integer, Hash)>] VPMemVolumes data, response status code and response headers
    def pcloud_pvminstances_vpmem_volumes_post_with_http_info(cloud_instance_id, pvm_instance_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_post ...'
      end
      # verify the required parameter 'cloud_instance_id' is set
      if @api_client.config.client_side_validation && cloud_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'cloud_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_post"
      end
      # verify the required parameter 'pvm_instance_id' is set
      if @api_client.config.client_side_validation && pvm_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'pvm_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_post"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_post"
      end
      # resource path
      local_var_path = '/pcloud/v1/cloud-instances/{cloud_instance_id}/pvm-instances/{pvm_instance_id}/vpmem-volumes'.sub('{cloud_instance_id}', CGI.escape(cloud_instance_id.to_s)).sub('{pvm_instance_id}', CGI.escape(pvm_instance_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PCloudVPMemVolumesApi#pcloud_pvminstances_vpmem_volumes_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param pvm_instance_id [String] PCloud PVM Instance ID
    # @param vpmem_volume_id [String] vPMEM Volume ID
    # @param body [VPMemVolumeUpdate] Parameters to update a vPMEM volume
    # @param [Hash] opts the optional parameters
    # @return [VPMemVolumeReference]
    def pcloud_pvminstances_vpmem_volumes_put(cloud_instance_id, pvm_instance_id, vpmem_volume_id, body, opts = {})
      data, _status_code, _headers = pcloud_pvminstances_vpmem_volumes_put_with_http_info(cloud_instance_id, pvm_instance_id, vpmem_volume_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(VPMemVolumeReference, Integer, Hash)>] VPMemVolumeReference data, response status code and response headers
    def pcloud_pvminstances_vpmem_volumes_put_with_http_info(cloud_instance_id, pvm_instance_id, vpmem_volume_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_put ...'
      end
      # verify the required parameter 'cloud_instance_id' is set
      if @api_client.config.client_side_validation && cloud_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'cloud_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_put"
      end
      # verify the required parameter 'pvm_instance_id' is set
      if @api_client.config.client_side_validation && pvm_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'pvm_instance_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_put"
      end
      # verify the required parameter 'vpmem_volume_id' is set
      if @api_client.config.client_side_validation && vpmem_volume_id.nil?
        fail ArgumentError, "Missing the required parameter 'vpmem_volume_id' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_put"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_put"
      end
      # resource path
      local_var_path = '/pcloud/v1/cloud-instances/{cloud_instance_id}/pvm-instances/{pvm_instance_id}/vpmem-volumes/{vpmem_volume_id}'.sub('{cloud_instance_id}', CGI.escape(cloud_instance_id.to_s)).sub('{pvm_instance_id}', CGI.escape(pvm_instance_id.to_s)).sub('{vpmem_volume_id}', CGI.escape(vpmem_volume_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PCloudVPMemVolumesApi.pcloud_pvminstances_vpmem_volumes_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PCloudVPMemVolumesApi#pcloud_pvminstances_vpmem_volumes_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
