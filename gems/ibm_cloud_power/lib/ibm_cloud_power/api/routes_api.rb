...
module IbmCloudPower
  class RoutesApi
    ...
    # @return [Object]
    def v1_routes_delete(route_id, opts = {})
      data, _status_code, _headers = v1_routes_delete_with_http_info(route_id, opts)
      data
    end
    ...
    def v1_routes_delete_with_http_info(route_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RoutesApi.v1_routes_delete ...'
      end
      # verify the required parameter 'route_id' is set
      if @api_client.config.client_side_validation && route_id.nil?
        fail ArgumentError, "Missing the required parameter 'route_id' when calling RoutesApi.v1_routes_delete"
      end
      # resource path
      local_var_path = '/v1/routes/{route_id}'.sub('{route_id}', CGI.escape(route_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"RoutesApi.v1_routes_delete",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RoutesApi#v1_routes_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Route]
    def v1_routes_get(route_id, opts = {})
      data, _status_code, _headers = v1_routes_get_with_http_info(route_id, opts)
      data
    end
    ...
    def v1_routes_get_with_http_info(route_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RoutesApi.v1_routes_get ...'
      end
      # verify the required parameter 'route_id' is set
      if @api_client.config.client_side_validation && route_id.nil?
        fail ArgumentError, "Missing the required parameter 'route_id' when calling RoutesApi.v1_routes_get"
      end
      # resource path
      local_var_path = '/v1/routes/{route_id}'.sub('{route_id}', CGI.escape(route_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"RoutesApi.v1_routes_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RoutesApi#v1_routes_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Routes]
    def v1_routes_getall(opts = {})
      data, _status_code, _headers = v1_routes_getall_with_http_info(opts)
      data
    end

    # Get all routes in the workspace
    # @param [Hash] opts the optional parameters
    # @return [Array<(Routes, Integer, Hash)>] Routes data, response status code and response headers
    def v1_routes_getall_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RoutesApi.v1_routes_getall ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Routes'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"RoutesApi.v1_routes_getall",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RoutesApi#v1_routes_getall\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [RouteCreate] :body Create a route based on the inputs
    # @return [Route]
    def v1_routes_post(opts = {})
      data, _status_code, _headers = v1_routes_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [RouteCreate] :body Create a route based on the inputs
    # @return [Array<(Route, Integer, Hash)>] Route data, response status code and response headers
    def v1_routes_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RoutesApi.v1_routes_post ...'
      end
      # resource path
      local_var_path = '/v1/routes'
      ...
      new_options = opts.merge(
        :operation => :"RoutesApi.v1_routes_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RoutesApi#v1_routes_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param route_id [String] Route ID
    # @param body [RouteUpdate] Parameters for updating a route
    # @param [Hash] opts the optional parameters
    # @return [Route]
    def v1_routes_put(route_id, body, opts = {})
      data, _status_code, _headers = v1_routes_put_with_http_info(route_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Route, Integer, Hash)>] Route data, response status code and response headers
    def v1_routes_put_with_http_info(route_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RoutesApi.v1_routes_put ...'
      end
      # verify the required parameter 'route_id' is set
      if @api_client.config.client_side_validation && route_id.nil?
        fail ArgumentError, "Missing the required parameter 'route_id' when calling RoutesApi.v1_routes_put"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RoutesApi.v1_routes_put"
      end
      # resource path
      local_var_path = '/v1/routes/{route_id}'.sub('{route_id}', CGI.escape(route_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"RoutesApi.v1_routes_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RoutesApi#v1_routes_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [RouteReport]
    def v1_routes_report_get(opts = {})
      data, _status_code, _headers = v1_routes_report_get_with_http_info(opts)
      data
    end

    # Get the route report for a workspace
    # @param [Hash] opts the optional parameters
    # @return [Array<(RouteReport, Integer, Hash)>] RouteReport data, response status code and response headers
    def v1_routes_report_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RoutesApi.v1_routes_report_get ...'
      end
      # resource path
      local_var_path = '/v1/routes/report'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RouteReport'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"RoutesApi.v1_routes_report_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RoutesApi#v1_routes_report_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
