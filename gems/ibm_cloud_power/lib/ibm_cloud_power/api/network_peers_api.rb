...
module IbmCloudPower
  class NetworkPeersApi
    ...
    # @return [NetworkPeers]
    def v1_network_peers_getall(opts = {})
      data, _status_code, _headers = v1_network_peers_getall_with_http_info(opts)
      data
    end

    # Get the list of Network Peers
    # @param [Hash] opts the optional parameters
    # @return [Array<(NetworkPeers, Integer, Hash)>] NetworkPeers data, response status code and response headers
    def v1_network_peers_getall_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_getall ...'
      end
      # resource path
      local_var_path = '/v1/network-peers'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'NetworkPeers'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_getall",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_getall\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # Delete a Network Peer
    # @param network_peer_id [String] network peer ID
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def v1_network_peers_id_delete(network_peer_id, opts = {})
      data, _status_code, _headers = v1_network_peers_id_delete_with_http_info(network_peer_id, opts)
      data
    end
    ...
    def v1_network_peers_id_delete_with_http_info(network_peer_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_id_delete ...'
      end
      # verify the required parameter 'network_peer_id' is set
      if @api_client.config.client_side_validation && network_peer_id.nil?
        fail ArgumentError, "Missing the required parameter 'network_peer_id' when calling NetworkPeersApi.v1_network_peers_id_delete"
      end
      # resource path
      local_var_path = '/v1/network-peers/{network_peer_id}'.sub('{network_peer_id}', CGI.escape(network_peer_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [NetworkPeer]
    def v1_network_peers_id_get(network_peer_id, opts = {})
      data, _status_code, _headers = v1_network_peers_id_get_with_http_info(network_peer_id, opts)
      data
    end
    ...
    # @param network_peer_id [String] network peer ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(NetworkPeer, Integer, Hash)>] NetworkPeer data, response status code and response headers
    def v1_network_peers_id_get_with_http_info(network_peer_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_id_get ...'
      end
      # verify the required parameter 'network_peer_id' is set
      if @api_client.config.client_side_validation && network_peer_id.nil?
        fail ArgumentError, "Missing the required parameter 'network_peer_id' when calling NetworkPeersApi.v1_network_peers_id_get"
      end
      # resource path
      local_var_path = '/v1/network-peers/{network_peer_id}'.sub('{network_peer_id}', CGI.escape(network_peer_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'NetworkPeer'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param network_peer_id [String] network peer ID
    # @param body [NetworkPeerUpdate] network peer update parameters
    # @param [Hash] opts the optional parameters
    # @return [NetworkPeer]
    def v1_network_peers_id_put(network_peer_id, body, opts = {})
      data, _status_code, _headers = v1_network_peers_id_put_with_http_info(network_peer_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NetworkPeer, Integer, Hash)>] NetworkPeer data, response status code and response headers
    def v1_network_peers_id_put_with_http_info(network_peer_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_id_put ...'
      end
      # verify the required parameter 'network_peer_id' is set
      if @api_client.config.client_side_validation && network_peer_id.nil?
        fail ArgumentError, "Missing the required parameter 'network_peer_id' when calling NetworkPeersApi.v1_network_peers_id_put"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NetworkPeersApi.v1_network_peers_id_put"
      end
      # resource path
      local_var_path = '/v1/network-peers/{network_peer_id}'.sub('{network_peer_id}', CGI.escape(network_peer_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_id_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def v1_network_peers_interfaces_getall(opts = {})
      data, _status_code, _headers = v1_network_peers_interfaces_getall_with_http_info(opts)
      data
    end

    # Get the list of Interfaces for Network Peer
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<PeerInterface>, Integer, Hash)>] Array<PeerInterface> data, response status code and response headers
    def v1_network_peers_interfaces_getall_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_interfaces_getall ...'
      end
      # resource path
      local_var_path = '/v1/network-peers/interfaces'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<PeerInterface>'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_interfaces_getall",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_interfaces_getall\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # Create a new Network Peer
    # @param body [NetworkPeerCreate] network peer create parameters
    # @param [Hash] opts the optional parameters
    # @return [NetworkPeer]
    def v1_network_peers_post(body, opts = {})
      data, _status_code, _headers = v1_network_peers_post_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(NetworkPeer, Integer, Hash)>] NetworkPeer data, response status code and response headers
    def v1_network_peers_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_post ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NetworkPeersApi.v1_network_peers_post"
      end
      # resource path
      local_var_path = '/v1/network-peers'
      ...
      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param network_peer_id [String] network peer ID
    # @param route_filter_id [String] route filter ID
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def v1_network_peers_route_filter_id_delete(network_peer_id, route_filter_id, opts = {})
      data, _status_code, _headers = v1_network_peers_route_filter_id_delete_with_http_info(network_peer_id, route_filter_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def v1_network_peers_route_filter_id_delete_with_http_info(network_peer_id, route_filter_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_route_filter_id_delete ...'
      end
      # verify the required parameter 'network_peer_id' is set
      if @api_client.config.client_side_validation && network_peer_id.nil?
        fail ArgumentError, "Missing the required parameter 'network_peer_id' when calling NetworkPeersApi.v1_network_peers_route_filter_id_delete"
      end
      # verify the required parameter 'route_filter_id' is set
      if @api_client.config.client_side_validation && route_filter_id.nil?
        fail ArgumentError, "Missing the required parameter 'route_filter_id' when calling NetworkPeersApi.v1_network_peers_route_filter_id_delete"
      end
      # resource path
      local_var_path = '/v1/network-peers/{network_peer_id}/route-filters/{route_filter_id}'.sub('{network_peer_id}', CGI.escape(network_peer_id.to_s)).sub('{route_filter_id}', CGI.escape(route_filter_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_route_filter_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_route_filter_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [RouteFilter]
    def v1_network_peers_route_filter_id_get(network_peer_id, route_filter_id, opts = {})
      data, _status_code, _headers = v1_network_peers_route_filter_id_get_with_http_info(network_peer_id, route_filter_id, opts)
      data
    end
    ...
    # @param route_filter_id [String] route filter ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(RouteFilter, Integer, Hash)>] RouteFilter data, response status code and response headers
    def v1_network_peers_route_filter_id_get_with_http_info(network_peer_id, route_filter_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_route_filter_id_get ...'
      end
      # verify the required parameter 'network_peer_id' is set
      if @api_client.config.client_side_validation && network_peer_id.nil?
        fail ArgumentError, "Missing the required parameter 'network_peer_id' when calling NetworkPeersApi.v1_network_peers_route_filter_id_get"
      end
      # verify the required parameter 'route_filter_id' is set
      if @api_client.config.client_side_validation && route_filter_id.nil?
        fail ArgumentError, "Missing the required parameter 'route_filter_id' when calling NetworkPeersApi.v1_network_peers_route_filter_id_get"
      end
      # resource path
      local_var_path = '/v1/network-peers/{network_peer_id}/route-filters/{route_filter_id}'.sub('{network_peer_id}', CGI.escape(network_peer_id.to_s)).sub('{route_filter_id}', CGI.escape(route_filter_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RouteFilter'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_route_filter_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_route_filter_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param network_peer_id [String] network peer ID
    # @param body [RouteFilterCreate] route filter create parameters.
    # @param [Hash] opts the optional parameters
    # @return [RouteFilter]
    def v1_network_peers_route_filter_post(network_peer_id, body, opts = {})
      data, _status_code, _headers = v1_network_peers_route_filter_post_with_http_info(network_peer_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(RouteFilter, Integer, Hash)>] RouteFilter data, response status code and response headers
    def v1_network_peers_route_filter_post_with_http_info(network_peer_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NetworkPeersApi.v1_network_peers_route_filter_post ...'
      end
      # verify the required parameter 'network_peer_id' is set
      if @api_client.config.client_side_validation && network_peer_id.nil?
        fail ArgumentError, "Missing the required parameter 'network_peer_id' when calling NetworkPeersApi.v1_network_peers_route_filter_post"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NetworkPeersApi.v1_network_peers_route_filter_post"
      end
      # resource path
      local_var_path = '/v1/network-peers/{network_peer_id}/route-filters'.sub('{network_peer_id}', CGI.escape(network_peer_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"NetworkPeersApi.v1_network_peers_route_filter_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NetworkPeersApi#v1_network_peers_route_filter_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
