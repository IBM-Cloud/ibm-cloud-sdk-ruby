...
module IbmCloudPower
  class SSHKeysApi
    ...
    # Delete ssh-key
    # @param sshkey_id [String] SSH Key ID
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def v1_sshkeys_delete(sshkey_id, opts = {})
      data, _status_code, _headers = v1_sshkeys_delete_with_http_info(sshkey_id, opts)
      data
    end
    ...
    def v1_sshkeys_delete_with_http_info(sshkey_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSHKeysApi.v1_sshkeys_delete ...'
      end
      # verify the required parameter 'sshkey_id' is set
      if @api_client.config.client_side_validation && sshkey_id.nil?
        fail ArgumentError, "Missing the required parameter 'sshkey_id' when calling SSHKeysApi.v1_sshkeys_delete"
      end
      # resource path
      local_var_path = '/v1/ssh-keys/{sshkey_id}'.sub('{sshkey_id}', CGI.escape(sshkey_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SSHKeysApi.v1_sshkeys_delete",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SSHKeysApi#v1_sshkeys_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param sshkey_id [String] SSH Key ID
    # @param [Hash] opts the optional parameters
    # @return [WorkspaceSSHKey]
    def v1_sshkeys_get(sshkey_id, opts = {})
      data, _status_code, _headers = v1_sshkeys_get_with_http_info(sshkey_id, opts)
      data
    end
    ...
    # @param sshkey_id [String] SSH Key ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkspaceSSHKey, Integer, Hash)>] WorkspaceSSHKey data, response status code and response headers
    def v1_sshkeys_get_with_http_info(sshkey_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSHKeysApi.v1_sshkeys_get ...'
      end
      # verify the required parameter 'sshkey_id' is set
      if @api_client.config.client_side_validation && sshkey_id.nil?
        fail ArgumentError, "Missing the required parameter 'sshkey_id' when calling SSHKeysApi.v1_sshkeys_get"
      end
      # resource path
      local_var_path = '/v1/ssh-keys/{sshkey_id}'.sub('{sshkey_id}', CGI.escape(sshkey_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'WorkspaceSSHKey'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SSHKeysApi.v1_sshkeys_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SSHKeysApi#v1_sshkeys_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # List SSH Keys
    # @param [Hash] opts the optional parameters
    # @return [WorkspaceSSHKeys]
    def v1_sshkeys_getall(opts = {})
      data, _status_code, _headers = v1_sshkeys_getall_with_http_info(opts)
      data
    end

    # List SSH Keys
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkspaceSSHKeys, Integer, Hash)>] WorkspaceSSHKeys data, response status code and response headers
    def v1_sshkeys_getall_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSHKeysApi.v1_sshkeys_getall ...'
      end
      # resource path
      local_var_path = '/v1/ssh-keys'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'WorkspaceSSHKeys'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SSHKeysApi.v1_sshkeys_getall",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SSHKeysApi#v1_sshkeys_getall\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # Add a new SSH key
    # @param body [CreateWorkspaceSSHKey] Parameters for the creation of a new SSH key
    # @param [Hash] opts the optional parameters
    # @return [WorkspaceSSHKey]
    def v1_sshkeys_post(body, opts = {})
      data, _status_code, _headers = v1_sshkeys_post_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkspaceSSHKey, Integer, Hash)>] WorkspaceSSHKey data, response status code and response headers
    def v1_sshkeys_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSHKeysApi.v1_sshkeys_post ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SSHKeysApi.v1_sshkeys_post"
      end
      # resource path
      local_var_path = '/v1/ssh-keys'
      ...
      new_options = opts.merge(
        :operation => :"SSHKeysApi.v1_sshkeys_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SSHKeysApi#v1_sshkeys_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # Update the ssh key
    # @param sshkey_id [String] SSH Key ID
    # @param body [UpdateWorkspaceSSHKey] Parameter for updating SSH key
    # @param [Hash] opts the optional parameters
    # @return [WorkspaceSSHKey]
    def v1_sshkeys_put(sshkey_id, body, opts = {})
      data, _status_code, _headers = v1_sshkeys_put_with_http_info(sshkey_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkspaceSSHKey, Integer, Hash)>] WorkspaceSSHKey data, response status code and response headers
    def v1_sshkeys_put_with_http_info(sshkey_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSHKeysApi.v1_sshkeys_put ...'
      end
      # verify the required parameter 'sshkey_id' is set
      if @api_client.config.client_side_validation && sshkey_id.nil?
        fail ArgumentError, "Missing the required parameter 'sshkey_id' when calling SSHKeysApi.v1_sshkeys_put"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SSHKeysApi.v1_sshkeys_put"
      end
      # resource path
      local_var_path = '/v1/ssh-keys/{sshkey_id}'.sub('{sshkey_id}', CGI.escape(sshkey_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SSHKeysApi.v1_sshkeys_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SSHKeysApi#v1_sshkeys_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
