...
module IbmCloudPower
  ...
  class PowerCloudApiV1 < IBMCloudSdkCore::BaseService
    ...
    ##
    # @!method pcloud_pvminstances_networks_delete(cloud_instance_id:, pvm_instance_id:, network_id:, mac_address: nil)
    # Remove all addresses of network from a PVM instance.
    # @param cloud_instance_id [String] Cloud Instance ID of a PCloud Instance.
    # @param pvm_instance_id [String] PCloud PVM Instance ID.
    # @param network_id [String] Network ID.
    # @param mac_address [String] The mac address of the network interface to be removed.
    # @return [nil]
    def pcloud_pvminstances_networks_delete(cloud_instance_id:, pvm_instance_id:, network_id:, mac_address: nil)
      raise ArgumentError.new("cloud_instance_id must be provided") if cloud_instance_id.nil?
    ...
    ##
    # @!method pcloud_placementgroups_members_delete(cloud_instance_id:, placement_group_id:, id:)
    # Remove server from placement group.
    # @param cloud_instance_id [String] Cloud Instance ID of a PCloud Instance.
    # @param placement_group_id [String] Placement Group ID or Placement Group Name.
    # @param id [String] The ID of the Server.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    def pcloud_placementgroups_members_delete(cloud_instance_id:, placement_group_id:, id:)
      raise ArgumentError.new("cloud_instance_id must be provided") if cloud_instance_id.nil?
