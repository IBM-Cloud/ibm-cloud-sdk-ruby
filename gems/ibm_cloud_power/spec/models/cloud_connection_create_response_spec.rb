...
# Unit tests for IbmCloudPower::CloudConnectionCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudPower::CloudConnectionCreateResponse do
  let(:instance) { IbmCloudPower::CloudConnectionCreateResponse.new }

  describe 'test an instance of CloudConnectionCreateResponse' do
    it 'should create an instance of CloudConnectionCreateResponse' do
      expect(instance).to be_instance_of(IbmCloudPower::CloudConnectionCreateResponse)
    end
  end
