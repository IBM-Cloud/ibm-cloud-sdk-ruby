...
describe IbmCloudPower::PVMInstanceCreate do
  #let(:instance) { IbmCloudPower::PVMInstanceCreate.new }
  ...
  describe 'test attribute "storage_connection"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["vSCSI", "maxVolumeSupport"])
      # validator.allowable_values.each do |value|
      #   expect { instance.storage_connection = value }.not_to raise_error
      # end
    end
  end
