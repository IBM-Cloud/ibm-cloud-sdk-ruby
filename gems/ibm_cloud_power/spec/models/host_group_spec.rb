...
# Unit tests for IbmCloudPower::HostGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudPower::HostGroup do
  let(:instance) { IbmCloudPower::HostGroup.new }

  describe 'test an instance of HostGroup' do
    it 'should create an instance of HostGroup' do
      expect(instance).to be_instance_of(IbmCloudPower::HostGroup)
    end
  end
