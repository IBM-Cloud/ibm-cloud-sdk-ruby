...
# Unit tests for IbmCloudPower::PVMInstanceUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudPower::PVMInstanceUpdate do
  let(:instance) { IbmCloudPower::PVMInstanceUpdate.new }

  describe 'test an instance of PVMInstanceUpdate' do
    it 'should create an instance of PVMInstanceUpdate' do
      expect(instance).to be_instance_of(IbmCloudPower::PVMInstanceUpdate)
    end
  end
  ...
  describe 'test attribute "sap_profile_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
