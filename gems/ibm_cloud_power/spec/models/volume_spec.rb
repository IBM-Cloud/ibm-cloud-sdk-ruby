...
# Unit tests for IbmCloudPower::Volume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudPower::Volume do
  #let(:instance) { IbmCloudPower::Volume.new }

  describe 'test an instance of Volume' do
    it 'should create an instance of Volume' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IbmCloudPower::Volume)
    end
  end
