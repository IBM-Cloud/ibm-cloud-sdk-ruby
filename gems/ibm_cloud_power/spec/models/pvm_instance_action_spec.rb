...
describe IbmCloudPower::PVMInstanceAction do
  let(:instance) { IbmCloudPower::PVMInstanceAction.new }
  ...
  describe 'test attribute "action"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["start", "stop", "immediate-shutdown", "hard-reboot", "soft-reboot", "reset-state", "dhcp-ip-sync"])
