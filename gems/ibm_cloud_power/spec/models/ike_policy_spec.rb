...
# Unit tests for IbmCloudPower::IKEPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IbmCloudPower::IKEPolicy do
  let(:instance) { IbmCloudPower::IKEPolicy.new }

  describe 'test an instance of IKEPolicy' do
    it 'should create an instance of IKEPolicy' do
      expect(instance).to be_instance_of(IbmCloudPower::IKEPolicy)
    end
  end
