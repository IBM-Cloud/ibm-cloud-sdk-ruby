...
```shell
gem install ./ibm_cloud_power-3.0.0.gem
```

(for development, run `gem install --dev ./ibm_cloud_power-3.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ibm_cloud_power', '~> 3.0.0'
