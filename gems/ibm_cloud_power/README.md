...
# IBM Cloud Power Ruby SDK

Ruby client library to interact with various [IBM Cloud Power Systems Virtual Server APIs](https://cloud.ibm.com/apidocs?category=power-cloud).
...
The IBM Cloud Power Systems Virtual Server Ruby SDK allows developers to programmatically interact with the following
IBM Cloud services:
