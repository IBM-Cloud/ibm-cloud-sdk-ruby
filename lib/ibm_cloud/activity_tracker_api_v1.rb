...
module IBMCloud
  ...
  class ActivityTrackerApiV1 < IBMCloudSdkCore::BaseService
    ...
    DEFAULT_SERVICE_URL = "https://<region>.logging.cloud.ibm.com"
    ##
    ...
    def export(from:, to:, size: nil, hosts: nil, apps: nil, levels: nil, query: nil, prefer: nil, email: nil, email_subject: nil)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "export")
    ...
    def exportv2(from:, to:, size: nil, hosts: nil, apps: nil, levels: nil, query: nil, prefer: nil, pagination_id: nil)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "exportv2")
      headers.merge!(sdk_headers)
    ...
    def create_view(config_request:, content_type: nil)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "create_view")
      headers.merge!(sdk_headers)
    ...
    def update_view(view_id:, config_request:, content_type: nil)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "update_view")
      headers.merge!(sdk_headers)
    ...
    def delete_view(view_id:)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "delete_view")
      headers.merge!(sdk_headers)
    ...
    def list_group
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "list_group")
      headers.merge!(sdk_headers)
    ...
    def create_group(groups_request:, content_type: nil)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "create_group")
      headers.merge!(sdk_headers)
    ...
    def read_group(group_id:)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "read_group")
      headers.merge!(sdk_headers)
    ...
    def delete_group(group_id:)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "delete_group")
      headers.merge!(sdk_headers)
    ...
    def update_group(group_id:, groups_request:, content_type: nil)
      ...
      sdk_headers = Common.new.get_sdk_headers("activity_tracker_api", "V1", "update_group")
      headers.merge!(sdk_headers)
